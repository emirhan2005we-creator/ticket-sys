...
`)+`
`+p);let E=A+m+a,v=A+p+o,S=Nh(s,s.VERTEX_SHADER,E),b=Nh(s,s.FRAGMENT_SHADER,v);s.attachShader(M,S),s.attachShader(M,b),e.index0AttributeName!==void 0?s.bindAttribLocation(M,0,e.index0AttributeName):e.hasPositionAttribute===!0&&s.bindAttribLocation(M,0,"position"),s.linkProgram(M);function C(P){if(i.debug.checkShaderErrors){let O=s.getProgramInfoLog(M)||"",B=s.getShaderInfoLog(S)||"",L=s.getShaderInfoLog(b)||"",z=O.trim(),q=B.trim(),Y=L.trim(),tt=!0,X=!0;if(s.getProgramParameter(M,s.LINK_STATUS)===!1)if(tt=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,M,S,b);else{let V=Fh(s,S,"vertex"),W=Fh(s,b,"fragment");Ht("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(M,s.VALIDATE_STATUS)+`
...
Program Info Log: `+z+`
`+V+`
`+W)}else z!==""?Vt("WebGLProgram: Program Info Log:",z):(q===""||Y==="")&&(X=!1);X&&(P.diagnostics={runnable:tt,programLog:z,vertexShader:{log:q,prefix:m},fragmentShader:{log:Y,prefix:p}})}s.deleteShader(S),s.deleteShader(b),x=new es(s,M),w=Eg(s,M)}let x;this.getUniforms=function(){return x===void 0&&C(this),x};let w;this.getAttributes=function(){return w===void 0&&C(this),w};let I=e.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return I===!1&&(I=s.getProgramParameter(M,_g)),I},this.destroy=function(){n.releaseStatesOfProgram(this),s.deleteProgram(M),this.program=void 0},this.type=e.shaderType,this.name=e.shaderName,this.id=xg++,this.cacheKey=t,this.usedTimes=1,this.program=M,this.vertexShader=S,this.fragmentShader=b,this}var Hg=0,kl=class{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(t,e,n){let s=this._getShaderCacheForMaterial(t);return s.has(e)===!1&&(s.add(e),e.usedTimes++),s.has(n)===!1&&(s.add(n),n.usedTimes++),this}remove(t){let e=this.materialCache.get(t);for(let n of e)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(t),this}getVertexShaderStage(t){return this._getShaderStage(t.vertexShader)}getFragmentShaderStage(t){return this._getShaderStage(t.fragmentShader)}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(t){let e=this.materialCache,n=e.get(t);return n===void 0&&(n=new Set,e.set(t,n)),n}_getShaderStage(t){let e=this.shaderCache,n=e.get(t);return n===void 0&&(n=new Gl(t),e.set(t,n)),n}},Gl=class{constructor(t){this.id=Hg++,this.code=t,this.usedTimes=0}};function Wg(i){return i===ei||i===Ys||i===Zs}function Xg(i,t,e,n,s,r){let a=new ys,o=new kl,l=new Set,c=[],h=new Map,d=n.logarithmicDepthBuffer,u=n.precision,f={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function g(x){return l.add(x),x===0?"uv":`uv${x}`}function M(x,w,I,P,O,B){let L=P.fog,z=O.geometry,q=x.isMeshStandardMaterial||x.isMeshLambertMaterial||x.isMeshPhongMaterial?P.environment:null,Y=x.isMeshStandardMaterial||x.isMeshLambertMaterial&&!x.envMap||x.isMeshPhongMaterial&&!x.envMap,tt=t.get(x.envMap||q,Y),X=tt&&tt.mapping===ks?tt.image.height:null,V=f[x.type];x.precision!==null&&(u=n.getMaxPrecision(x.precision),u!==x.precision&&Vt("WebGLProgram.getParameters:",x.precision,"not supported, using",u,"instead."));let W=z.morphAttributes.position||z.morphAttributes.normal||z.morphAttributes.color,lt=W!==void 0?W.length:0,_t=0;z.morphAttributes.position!==void 0&&(_t=1),z.morphAttributes.normal!==void 0&&(_t=2),z.morphAttributes.color!==void 0&&(_t=3);let Yt,Zt,jt,K;if(V){let he=Mn[V];Yt=he.vertexShader,Zt=he.fragmentShader}else{Yt=x.vertexShader,Zt=x.fragmentShader;let he=o.getVertexShaderStage(x),ie=o.getFragmentShaderStage(x);o.update(x,he,ie),jt=he.id,K=ie.id}let it=i.getRenderTarget(),xt=i.state.buffers.depth.getReversed(),zt=O.isInstancedMesh===!0,St=O.isBatchedMesh===!0,kt=!!x.map,ne=!!x.matcap,et=!!tt,Q=!!x.aoMap,rt=!!x.lightMap,at=!!x.bumpMap&&x.wireframe===!1,ht=!!x.normalMap,Bt=!!x.displacementMap,Ut=!!x.emissiveMap,Gt=!!x.metalnessMap,Tt=!!x.roughnessMap,R=x.anisotropy>0,Et=x.clearcoat>0,Pt=x.dispersion>0,T=x.retroreflectivity>0,_=x.iridescence>0,U=x.sheen>0,k=x.transmission>0,J=R&&!!x.anisotropyMap,ot=Et&&!!x.clearcoatMap,ut=Et&&!!x.clearcoatNormalMap,$=Et&&!!x.clearcoatRoughnessMap,nt=_&&!!x.iridescenceMap,pt=_&&!!x.iridescenceThicknessMap,Ct=U&&!!x.sheenColorMap,ft=U&&!!x.sheenRoughnessMap,mt=!!x.specularMap,Dt=!!x.specularColorMap,Ft=!!x.specularIntensityMap,Xt=k&&!!x.transmissionMap,F=k&&!!x.thicknessMap,dt=!!x.gradientMap,j=!!x.alphaMap,gt=x.alphaTest>0,bt=!!x.alphaHash,st=!!x.extensions,Ot=an;x.toneMapped&&(it===null||it.isXRRenderTarget===!0)&&(Ot=i.toneMapping);let Lt={shaderID:V,shaderType:x.type,shaderName:x.name,vertexShader:Yt,fragmentShader:Zt,defines:x.defines,customVertexShaderID:jt,customFragmentShaderID:K,isRawShaderMaterial:x.isRawShaderMaterial===!0,glslVersion:x.glslVersion,precision:u,batching:St,batchingColor:St&&O._colorsTexture!==null,instancing:zt,instancingColor:zt&&O.instanceColor!==null,instancingMorph:zt&&O.morphTexture!==null,outputColorSpace:it===null?i.outputColorSpace:it.isXRRenderTarget===!0?it.texture.colorSpace:te.workingColorSpace,alphaToCoverage:!!x.alphaToCoverage,map:kt,matcap:ne,envMap:et,envMapMode:et&&tt.mapping,envMapCubeUVHeight:X,aoMap:Q,lightMap:rt,bumpMap:at,normalMap:ht,displacementMap:Bt,emissiveMap:Ut,normalMapObjectSpace:ht&&x.normalMapType===ih,normalMapTangentSpace:ht&&x.normalMapType===eo,packedNormalMap:ht&&x.normalMapType===eo&&Wg(x.normalMap.format),metalnessMap:Gt,roughnessMap:Tt,anisotropy:R,anisotropyMap:J,clearcoat:Et,clearcoatMap:ot,clearcoatNormalMap:ut,clearcoatRoughnessMap:$,dispersion:Pt,retroreflection:T,iridescence:_,iridescenceMap:nt,iridescenceThicknessMap:pt,sheen:U,sheenColorMap:Ct,sheenRoughnessMap:ft,specularMap:mt,specularColorMap:Dt,specularIntensityMap:Ft,transmission:k,transmissionMap:Xt,thicknessMap:F,gradientMap:dt,opaque:x.transparent===!1&&x.blending===Yi&&x.alphaToCoverage===!1,alphaMap:j,alphaTest:gt,alphaHash:bt,combine:x.combine,mapUv:kt&&g(x.map.channel),aoMapUv:Q&&g(x.aoMap.channel),lightMapUv:rt&&g(x.lightMap.channel),bumpMapUv:at&&g(x.bumpMap.channel),normalMapUv:ht&&g(x.normalMap.channel),displacementMapUv:Bt&&g(x.displacementMap.channel),emissiveMapUv:Ut&&g(x.emissiveMap.channel),metalnessMapUv:Gt&&g(x.metalnessMap.channel),roughnessMapUv:Tt&&g(x.roughnessMap.channel),anisotropyMapUv:J&&g(x.anisotropyMap.channel),clearcoatMapUv:ot&&g(x.clearcoatMap.channel),clearcoatNormalMapUv:ut&&g(x.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:$&&g(x.clearcoatRoughnessMap.channel),iridescenceMapUv:nt&&g(x.iridescenceMap.channel),iridescenceThicknessMapUv:pt&&g(x.iridescenceThicknessMap.channel),sheenColorMapUv:Ct&&g(x.sheenColorMap.channel),sheenRoughnessMapUv:ft&&g(x.sheenRoughnessMap.channel),specularMapUv:mt&&g(x.specularMap.channel),specularColorMapUv:Dt&&g(x.specularColorMap.channel),specularIntensityMapUv:Ft&&g(x.specularIntensityMap.channel),transmissionMapUv:Xt&&g(x.transmissionMap.channel),thicknessMapUv:F&&g(x.thicknessMap.channel),alphaMapUv:j&&g(x.alphaMap.channel),vertexTangents:!!z.attributes.tangent&&(ht||R),vertexNormals:!!z.attributes.normal,vertexColors:x.vertexColors,vertexAlphas:x.vertexColors===!0&&!!z.attributes.color&&z.attributes.color.itemSize===4,pointsUvs:O.isPoints===!0&&!!z.attributes.uv&&(kt||j),fog:!!L,useFog:x.fog===!0,fogExp2:!!L&&L.isFogExp2,flatShading:x.wireframe===!1&&(x.flatShading===!0||z.attributes.normal===void 0&&ht===!1&&(x.isMeshLambertMaterial||x.isMeshPhongMaterial||x.isMeshStandardMaterial||x.isMeshPhysicalMaterial)),sizeAttenuation:x.sizeAttenuation===!0,logarithmicDepthBuffer:d,reversedDepthBuffer:xt,skinning:O.isSkinnedMesh===!0,hasPositionAttribute:z.attributes.position!==void 0,morphTargets:z.morphAttributes.position!==void 0,morphNormals:z.morphAttributes.normal!==void 0,morphColors:z.morphAttributes.color!==void 0,morphTargetsCount:lt,morphTextureStride:_t,numSunLights:w.sun.length,numDirLights:w.directional.length,numPointLights:w.point.length,numSpotLights:w.spot.length,numSpotLightMaps:w.spotLightMap.length,numRectAreaLights:w.rectArea.length,numHemiLights:w.hemi.length,numSunLightShadows:w.sunShadowMap.length,numDirLightShadows:w.directionalShadowMap.length,numPointLightShadows:w.pointShadowMap.length,numSpotLightShadows:w.spotShadowMap.length,numSpotLightShadowsWithMaps:w.numSpotLightShadowsWithMaps,numLightProbes:w.numLightProbes,numLightProbeGrids:B.length,numClippingPlanes:r.numPlanes,numClipIntersection:r.numIntersection,dithering:x.dithering,shadowMapEnabled:i.shadowMap.enabled&&I.length>0,shadowMapType:i.shadowMap.type,toneMapping:Ot,decodeVideoTexture:kt&&x.map.isVideoTexture===!0&&te.getTransfer(x.map.colorSpace)===re,decodeVideoTextureEmissive:Ut&&x.emissiveMap.isVideoTexture===!0&&te.getTransfer(x.emissiveMap.colorSpace)===re,premultipliedAlpha:x.premultipliedAlpha,doubleSided:x.side===Je,flipSided:x.side===ze,useDepthPacking:x.depthPacking>=0,depthPacking:x.depthPacking||0,index0AttributeName:x.index0AttributeName,extensionClipCullDistance:st&&x.extensions.clipCullDistance===!0&&e.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(st&&x.extensions.multiDraw===!0||St)&&e.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:e.has("KHR_parallel_shader_compile"),customProgramCacheKey:x.customProgramCacheKey()};return Lt.vertexUv1s=l.has(1),Lt.vertexUv2s=l.has(2),Lt.vertexUv3s=l.has(3),l.clear(),Lt}function m(x){let w=[];if(x.shaderID?w.push(x.shaderID):(w.push(x.customVertexShaderID),w.push(x.customFragmentShaderID)),x.defines!==void 0)for(let I in x.defines)w.push(I),w.push(x.defines[I]);return x.isRawShaderMaterial===!1&&(p(w,x),A(w,x),w.push(i.outputColorSpace)),w.push(x.customProgramCacheKey),w.join()}function p(x,w){x.push(w.precision),x.push(w.outputColorSpace),x.push(w.envMapMode),x.push(w.envMapCubeUVHeight),x.push(w.mapUv),x.push(w.alphaMapUv),x.push(w.lightMapUv),x.push(w.aoMapUv),x.push(w.bumpMapUv),x.push(w.normalMapUv),x.push(w.displacementMapUv),x.push(w.emissiveMapUv),x.push(w.metalnessMapUv),x.push(w.roughnessMapUv),x.push(w.anisotropyMapUv),x.push(w.clearcoatMapUv),x.push(w.clearcoatNormalMapUv),x.push(w.clearcoatRoughnessMapUv),x.push(w.iridescenceMapUv),x.push(w.iridescenceThicknessMapUv),x.push(w.sheenColorMapUv),x.push(w.sheenRoughnessMapUv),x.push(w.specularMapUv),x.push(w.specularColorMapUv),x.push(w.specularIntensityMapUv),x.push(w.transmissionMapUv),x.push(w.thicknessMapUv),x.push(w.combine),x.push(w.fogExp2),x.push(w.sizeAttenuation),x.push(w.morphTargetsCount),x.push(w.morphAttributeCount),x.push(w.numSunLights),x.push(w.numDirLights),x.push(w.numPointLights),x.push(w.numSpotLights),x.push(w.numSpotLightMaps),x.push(w.numHemiLights),x.push(w.numRectAreaLights),x.push(w.numSunLightShadows),x.push(w.numDirLightShadows),x.push(w.numPointLightShadows),x.push(w.numSpotLightShadows),x.push(w.numSpotLightShadowsWithMaps),x.push(w.numLightProbes),x.push(w.shadowMapType),x.push(w.toneMapping),x.push(w.numClippingPlanes),x.push(w.numClipIntersection),x.push(w.depthPacking)}function A(x,w){a.disableAll(),w.instancing&&a.enable(0),w.instancingColor&&a.enable(1),w.instancingMorph&&a.enable(2),w.matcap&&a.enable(3),w.envMap&&a.enable(4),w.normalMapObjectSpace&&a.enable(5),w.normalMapTangentSpace&&a.enable(6),w.clearcoat&&a.enable(7),w.iridescence&&a.enable(8),w.alphaTest&&a.enable(9),w.vertexColors&&a.enable(10),w.vertexAlphas&&a.enable(11),w.vertexUv1s&&a.enable(12),w.vertexUv2s&&a.enable(13),w.vertexUv3s&&a.enable(14),w.vertexTangents&&a.enable(15),w.anisotropy&&a.enable(16),w.alphaHash&&a.enable(17),w.batching&&a.enable(18),w.dispersion&&a.enable(19),w.retroreflection&&a.enable(24),w.batchingColor&&a.enable(20),w.gradientMap&&a.enable(21),w.packedNormalMap&&a.enable(22),w.vertexNormals&&a.enable(23),x.push(a.mask),a.disableAll(),w.fog&&a.enable(0),w.useFog&&a.enable(1),w.flatShading&&a.enable(2),w.logarithmicDepthBuffer&&a.enable(3),w.reversedDepthBuffer&&a.enable(4),w.skinning&&a.enable(5),w.morphTargets&&a.enable(6),w.morphNormals&&a.enable(7),w.morphColors&&a.enable(8),w.premultipliedAlpha&&a.enable(9),w.shadowMapEnabled&&a.enable(10),w.doubleSided&&a.enable(11),w.flipSided&&a.enable(12),w.useDepthPacking&&a.enable(13),w.dithering&&a.enable(14),w.transmission&&a.enable(15),w.sheen&&a.enable(16),w.opaque&&a.enable(17),w.pointsUvs&&a.enable(18),w.decodeVideoTexture&&a.enable(19),w.decodeVideoTextureEmissive&&a.enable(20),w.alphaToCoverage&&a.enable(21),w.numLightProbeGrids>0&&a.enable(22),w.hasPositionAttribute&&a.enable(23),x.push(a.mask)}function E(x){let w=f[x.type],I;if(w){let P=Mn[w];I=Mh.clone(P.uniforms)}else I=x.uniforms;return I}function v(x,w){let I=h.get(w);return I!==void 0?++I.usedTimes:(I=new Gg(i,w,x,s),c.push(I),h.set(w,I)),I}function S(x){if(--x.usedTimes===0){let w=c.indexOf(x);c[w]=c[c.length-1],c.pop(),h.delete(x.cacheKey),x.destroy()}}function b(x){o.remove(x)}function C(){o.dispose()}return{getParameters:M,getProgramCacheKey:m,getUniforms:E,acquireProgram:v,releaseProgram:S,releaseShaderCache:b,programs:c,dispose:C}}function qg(){let i=new WeakMap;function t(a){return i.has(a)}function e(a){let o=i.get(a);return o===void 0&&(o={},i.set(a,o)),o}function n(a){i.delete(a)}function s(a,o,l){i.get(a)[o]=l}function r(){i=new WeakMap}return{has:t,get:e,remove:n,update:s,dispose:r}}function Yg(i,t){return i.groupOrder!==t.groupOrder?i.groupOrder-t.groupOrder:i.renderOrder!==t.renderOrder?i.renderOrder-t.renderOrder:i.material.id!==t.material.id?i.material.id-t.material.id:i.materialVariant!==t.materialVariant?i.materialVariant-t.materialVariant:i.z!==t.z?i.z-t.z:i.id-t.id}function kh(i,t){return i.groupOrder!==t.groupOrder?i.groupOrder-t.groupOrder:i.renderOrder!==t.renderOrder?i.renderOrder-t.renderOrder:i.z!==t.z?t.z-i.z:i.id-t.id}function Gh(){let i=[],t=0,e=[],n=[],s=[];function r(){t=0,e.length=0,n.length=0,s.length=0}function a(u){let f=0;return u.isInstancedMesh&&(f+=2),u.isSkinnedMesh&&(f+=1),f}function o(u,f,g,M,m,p){let A=i[t];return A===void 0?(A={id:u.id,object:u,geometry:f,material:g,materialVariant:a(u),groupOrder:M,renderOrder:u.renderOrder,z:m,group:p},i[t]=A):(A.id=u.id,A.object=u,A.geometry=f,A.material=g,A.materialVariant=a(u),A.groupOrder=M,A.renderOrder=u.renderOrder,A.z=m,A.group=p),t++,A}function l(u,f,g,M,m,p,A){A.reversedDepth===!0&&(m=-m);let E=o(u,f,g,M,m,p);g.transmission>0?n.push(E):g.transparent===!0?s.push(E):e.push(E)}function c(u,f,g,M,m,p){let A=o(u,f,g,M,m,p);g.transmission>0?n.unshift(A):g.transparent===!0?s.unshift(A):e.unshift(A)}function h(u,f){e.length>1&&e.sort(u||Yg),n.length>1&&n.sort(f||kh),s.length>1&&s.sort(f||kh)}function d(){for(let u=t,f=i.length;u<f;u++){let g=i[u];if(g.id===null)break;g.id=null,g.object=null,g.geometry=null,g.material=null,g.group=null}}return{opaque:e,transmissive:n,transparent:s,init:r,push:l,unshift:c,finish:d,sort:h}}function Zg(){let i=new WeakMap;function t(n,s){let r=i.get(n),a;return r===void 0?(a=new Gh,i.set(n,[a])):s>=r.length?(a=new Gh,r.push(a)):a=r[s],a}function e(){i=new WeakMap}return{get:t,dispose:e}}function Jg(){let i={};return{get:function(t){if(i[t.id]!==void 0)return i[t.id];let e;switch(t.type){case"SunLight":case"DirectionalLight":e={direction:new D,color:new qt};break;case"SpotLight":e={position:new D,direction:new D,color:new qt,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":e={position:new D,color:new qt,distance:0,decay:0};break;case"HemisphereLight":e={direction:new D,skyColor:new qt,groundColor:new qt};break;case"RectAreaLight":e={color:new qt,position:new D,halfWidth:new D,halfHeight:new D};break}return i[t.id]=e,e}}}function $g(){let i={};return{get:function(t){if(i[t.id]!==void 0)return i[t.id];let e;switch(t.type){case"SunLight":case"DirectionalLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ct};break;case"SpotLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ct};break;case"PointLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ct,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[t.id]=e,e}}}var Kg=0;function Qg(i,t){return(t.castShadow?2:0)-(i.castShadow?2:0)+(t.map?1:0)-(i.map?1:0)}function jg(i){let t=new Jg,e=$g(),n={version:0,hash:{sunLength:-1,directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numSunShadows:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],sun:[],sunShadow:[],sunShadowMap:[],sunShadowMatrix:[],sunShadowCascade:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new D);let s=new D,r=new pe,a=new pe;function o(c){let h=0,d=0,u=0;for(let O=0;O<9;O++)n.probe[O].set(0,0,0);let f=0,g=0,M=0,m=0,p=0,A=0,E=0,v=0,S=0,b=0,C=0,x=0,w=0,I=0;c.sort(Qg);for(let O=0,B=c.length;O<B;O++){let L=c[O],z=L.color,q=L.intensity,Y=L.distance,tt=null;if(L.shadow&&L.shadow.map&&(L.shadow.map.texture.format===ei?tt=L.shadow.map.texture:tt=L.shadow.map.depthTexture||L.shadow.map.texture),L.isAmbientLight)h+=z.r*q,d+=z.g*q,u+=z.b*q;else if(L.isLightProbe){for(let X=0;X<9;X++)n.probe[X].addScaledVector(L.sh.coefficients[X],q);I++}else if(L.isSunLight){let X=t.get(L);if(X.color.copy(L.color).multiplyScalar(L.intensity),L.castShadow){let V=L.shadow,W=e.get(L);W.shadowIntensity=V.intensity,W.shadowBias=V.bias,W.shadowNormalBias=V.normalBias,W.shadowRadius=V.radius,W.shadowMapSize.copy(V.mapSize).multiply(V.getFrameExtents()),n.sunShadow[g]=W,n.sunShadowMap[g]=tt;let lt=V.getViewportCount();for(let _t=0;_t<lt;_t++)n.sunShadowMatrix[M+_t]=V.getMatrix(_t),n.sunShadowCascade[M+_t]=V._cascadeData[_t];M+=lt,g++}n.sun[f]=X,f++}else if(L.isDirectionalLight){let X=t.get(L);if(X.color.copy(L.color).multiplyScalar(L.intensity),L.castShadow){let V=L.shadow,W=e.get(L);W.shadowIntensity=V.intensity,W.shadowBias=V.bias,W.shadowNormalBias=V.normalBias,W.shadowRadius=V.radius,W.shadowMapSize=V.mapSize,n.directionalShadow[m]=W,n.directionalShadowMap[m]=tt,n.directionalShadowMatrix[m]=L.shadow.matrix,S++}n.directional[m]=X,m++}else if(L.isSpotLight){let X=t.get(L);X.position.setFromMatrixPosition(L.matrixWorld),X.color.copy(z).multiplyScalar(q),X.distance=Y,X.coneCos=Math.cos(L.angle),X.penumbraCos=Math.cos(L.angle*(1-L.penumbra)),X.decay=L.decay,n.spot[A]=X;let V=L.shadow;if(L.map&&(n.spotLightMap[x]=L.map,x++,V.updateMatrices(L),L.castShadow&&w++),n.spotLightMatrix[A]=V.matrix,L.castShadow){let W=e.get(L);W.shadowIntensity=V.intensity,W.shadowBias=V.bias,W.shadowNormalBias=V.normalBias,W.shadowRadius=V.radius,W.shadowMapSize=V.mapSize,n.spotShadow[A]=W,n.spotShadowMap[A]=tt,C++}A++}else if(L.isRectAreaLight){let X=t.get(L);X.color.copy(z).multiplyScalar(q),X.halfWidth.set(L.width*.5,0,0),X.halfHeight.set(0,L.height*.5,0),n.rectArea[E]=X,E++}else if(L.isPointLight){let X=t.get(L);if(X.color.copy(L.color).multiplyScalar(L.intensity),X.distance=L.distance,X.decay=L.decay,L.castShadow){let V=L.shadow,W=e.get(L);W.shadowIntensity=V.intensity,W.shadowBias=V.bias,W.shadowNormalBias=V.normalBias,W.shadowRadius=V.radius,W.shadowMapSize=V.mapSize,W.shadowCameraNear=V.camera.near,W.shadowCameraFar=V.camera.far,n.pointShadow[p]=W,n.pointShadowMap[p]=tt,n.pointShadowMatrix[p]=L.shadow.matrix,b++}n.point[p]=X,p++}else if(L.isHemisphereLight){let X=t.get(L);X.skyColor.copy(L.color).multiplyScalar(q),X.groundColor.copy(L.groundColor).multiplyScalar(q),n.hemi[v]=X,v++}}E>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=vt.LTC_FLOAT_1,n.rectAreaLTC2=vt.LTC_FLOAT_2):(n.rectAreaLTC1=vt.LTC_HALF_1,n.rectAreaLTC2=vt.LTC_HALF_2)),n.ambient[0]=h,n.ambient[1]=d,n.ambient[2]=u;let P=n.hash;(P.sunLength!==f||P.directionalLength!==m||P.pointLength!==p||P.spotLength!==A||P.rectAreaLength!==E||P.hemiLength!==v||P.numSunShadows!==g||P.numDirectionalShadows!==S||P.numPointShadows!==b||P.numSpotShadows!==C||P.numSpotMaps!==x||P.numLightProbes!==I)&&(n.sun.length=f,n.directional.length=m,n.spot.length=A,n.rectArea.length=E,n.point.length=p,n.hemi.length=v,n.sunShadow.length=g,n.sunShadowMap.length=g,n.sunShadowMatrix.length=M,n.sunShadowCascade.length=M,n.directionalShadow.length=S,n.directionalShadowMap.length=S,n.directionalShadowMatrix.length=S,n.pointShadow.length=b,n.pointShadowMap.length=b,n.pointShadowMatrix.length=b,n.spotShadow.length=C,n.spotShadowMap.length=C,n.spotLightMatrix.length=C+x-w,n.spotLightMap.length=x,n.numSpotLightShadowsWithMaps=w,n.numLightProbes=I,P.sunLength=f,P.directionalLength=m,P.pointLength=p,P.spotLength=A,P.rectAreaLength=E,P.hemiLength=v,P.numSunShadows=g,P.numDirectionalShadows=S,P.numPointShadows=b,P.numSpotShadows=C,P.numSpotMaps=x,P.numLightProbes=I,n.version=Kg++)}function l(c,h){let d=0,u=0,f=0,g=0,M=0,m=0,p=h.matrixWorldInverse;for(let A=0,E=c.length;A<E;A++){let v=c[A];if(v.isSunLight){let S=n.sun[d];S.direction.setFromMatrixPosition(v.matrixWorld),S.direction.transformDirection(p),d++}else if(v.isDirectionalLight){let S=n.directional[u];S.direction.setFromMatrixPosition(v.matrixWorld),s.setFromMatrixPosition(v.target.matrixWorld),S.direction.sub(s),S.direction.transformDirection(p),u++}else if(v.isSpotLight){let S=n.spot[g];S.position.setFromMatrixPosition(v.matrixWorld),S.position.applyMatrix4(p),S.direction.setFromMatrixPosition(v.matrixWorld),s.setFromMatrixPosition(v.target.matrixWorld),S.direction.sub(s),S.direction.transformDirection(p),g++}else if(v.isRectAreaLight){let S=n.rectArea[M];S.position.setFromMatrixPosition(v.matrixWorld),S.position.applyMatrix4(p),a.identity(),r.copy(v.matrixWorld),r.premultiply(p),a.extractRotation(r),S.halfWidth.set(v.width*.5,0,0),S.halfHeight.set(0,v.height*.5,0),S.halfWidth.applyMatrix4(a),S.halfHeight.applyMatrix4(a),M++}else if(v.isPointLight){let S=n.point[f];S.position.setFromMatrixPosition(v.matrixWorld),S.position.applyMatrix4(p),f++}else if(v.isHemisphereLight){let S=n.hemi[m];S.direction.setFromMatrixPosition(v.matrixWorld),S.direction.transformDirection(p),m++}}}return{setup:o,setupView:l,state:n}}function Hh(i){let t=new jg(i),e=[],n=[],s=[];function r(u){d.camera=u,e.length=0,n.length=0,s.length=0}function a(u){e.push(u)}function o(u){n.push(u)}function l(u){s.push(u)}function c(){t.setup(e)}function h(u){t.setupView(e,u)}let d={lightsArray:e,shadowsArray:n,lightProbeGridArray:s,camera:null,lights:t,transmissionRenderTarget:{},textureUnits:0};return{init:r,state:d,setupLights:c,setupLightsView:h,pushLight:a,pushShadow:o,pushLightProbeGrid:l}}function t0(i){let t=new WeakMap;function e(s,r=0){let a=t.get(s),o;return a===void 0?(o=new Hh(i),t.set(s,[o])):r>=a.length?(o=new Hh(i),a.push(o)):o=a[r],o}function n(){t=new WeakMap}return{get:e,dispose:n}}var e0=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,i0=[new D(1,0,0),new D(-1,0,0),new D(0,1,0),new D(0,-1,0),new D(0,0,1),new D(0,0,-1)],s0=[new D(0,-1,0),new D(0,-1,0),new D(0,0,1),new D(0,0,-1),new D(0,-1,0),new D(0,-1,0)],Wh=new pe,$s=new D,Ul=new D;function r0(i,t,e){let n=new Bi,s=new ct,r=new ct,a=new me,o=new ta,l=new ea,c={},h=e.maxTextureSize,d={[Kn]:ze,[ze]:Kn,[Je]:Je},u=new Ye({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ct},radius:{value:4}},vertexShader:e0,fragmentShader:n0}),f=u.clone();f.defines.HORIZONTAL_PASS=1;let g=new Me;g.setAttribute("position",new we(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let M=new le(g,u),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Vs;let p=this.type;this.render=function(b,C,x){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||b.length===0)return;this.type===Nc&&(Vt("WebGLShadowMap: PCFSoftShadowMap has been removed. Using PCFShadowMap instead."),this.type=Vs);let w=i.getRenderTarget(),I=i.getActiveCubeFace(),P=i.getActiveMipmapLevel(),O=i.state;O.setBlending(vn),O.buffers.depth.getReversed()===!0?O.buffers.color.setClear(0,0,0,0):O.buffers.color.setClear(1,1,1,1),O.buffers.depth.setTest(!0),O.setScissorTest(!1);let B=p!==this.type;B&&C.traverse(function(L){L.material&&(Array.isArray(L.material)?L.material.forEach(z=>z.needsUpdate=!0):L.material.needsUpdate=!0)});for(let L=0,z=b.length;L<z;L++){let q=b[L],Y=q.shadow;if(Y===void 0){Vt("WebGLShadowMap:",q,"has no shadow.");continue}if(Y.autoUpdate===!1&&Y.needsUpdate===!1)continue;s.copy(Y.mapSize);let tt=Y.getFrameExtents();s.multiply(tt),r.copy(Y.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/tt.x),s.x=r.x*tt.x,Y.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/tt.y),s.y=r.y*tt.y,Y.mapSize.y=r.y));let X=i.state.buffers.depth.getReversed();if(Y.camera._reversedDepth=X,Y.map===null||B===!0){if(Y.map!==null&&(Y.map.depthTexture!==null&&(Y.map.depthTexture.dispose(),Y.map.depthTexture=null),Y.map.dispose()),this.type===qi){if(q.isPointLight){Vt("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}Y.map=new ke(s.x,s.y,{format:ei,type:cn,minFilter:Ce,magFilter:Ce,generateMipmaps:!1}),Y.map.texture.name=q.name+".shadowMap",Y.map.depthTexture=new Wn(s.x,s.y,ln),Y.map.depthTexture.name=q.name+".shadowMapDepth",Y.map.depthTexture.format=mn,Y.map.depthTexture.compareFunction=null,Y.map.depthTexture.minFilter=Ae,Y.map.depthTexture.magFilter=Ae}else q.isPointLight?(Y.map=new ao(s.x),Y.map.depthTexture=new Xr(s.x,on)):(Y.map=new ke(s.x,s.y),Y.map.depthTexture=new Wn(s.x,s.y,on)),Y.map.depthTexture.name=q.name+".shadowMap",Y.map.depthTexture.format=mn,this.type===Vs?(Y.map.depthTexture.compareFunction=X?io:no,Y.map.depthTexture.minFilter=Ce,Y.map.depthTexture.magFilter=Ce):(Y.map.depthTexture.compareFunction=null,Y.map.depthTexture.minFilter=Ae,Y.map.depthTexture.magFilter=Ae);Y.camera.updateProjectionMatrix()}Y.map.isWebGLCubeRenderTarget!==!0&&(Y.map.width!==s.x||Y.map.height!==s.y)&&Y.map.setSize(s.x,s.y);let V=Y.map.isWebGLCubeRenderTarget?6:Y.getViewportCount();q.isPointLight!==!0&&Y.updateMatrices(q,x);for(let W=0;W<V;W++){let lt=Y.getCamera(W);if(q.isPointLight){let _t=Y.camera,Yt=Y.matrix,Zt=q.distance||_t.far;Zt!==_t.far&&(_t.far=Zt,_t.updateProjectionMatrix()),$s.setFromMatrixPosition(q.matrixWorld),_t.position.copy($s),Ul.copy(_t.position),Ul.add(i0[W]),_t.up.copy(s0[W]),_t.lookAt(Ul),_t.updateMatrixWorld(),Yt.makeTranslation(-$s.x,-$s.y,-$s.z),Wh.multiplyMatrices(_t.projectionMatrix,_t.matrixWorldInverse),Y._frustum.setFromProjectionMatrix(Wh,_t.coordinateSystem,_t.reversedDepth)}if(Y.map.isWebGLCubeRenderTarget)i.setRenderTarget(Y.map,W),i.clear();else{W===0&&(i.setRenderTarget(Y.map),i.clear());let _t=Y.getViewport(W);a.set(r.x*_t.x,r.y*_t.y,r.x*_t.z,r.y*_t.w),O.viewport(a)}n=Y.getFrustum(W),v(C,x,lt,q,this.type)}Y.isPointLightShadow!==!0&&this.type===qi&&A(Y,x),Y.needsUpdate=!1}p=this.type,m.needsUpdate=!1,i.setRenderTarget(w,I,P)};function A(b,C){let x=t.update(M);u.defines.VSM_SAMPLES!==b.blurSamples&&(u.defines.VSM_SAMPLES=b.blurSamples,f.defines.VSM_SAMPLES=b.blurSamples,u.needsUpdate=!0,f.needsUpdate=!0),b.mapPass===null?b.mapPass=new ke(s.x,s.y,{format:ei,type:cn}):(b.mapPass.width!==b.map.width||b.mapPass.height!==b.map.height)&&b.mapPass.setSize(b.map.width,b.map.height),u.uniforms.shadow_pass.value=b.map.depthTexture,u.uniforms.resolution.value.set(b.map.width,b.map.height),u.uniforms.radius.value=b.radius,i.setRenderTarget(b.mapPass),i.clear(),i.renderBufferDirect(C,null,x,u,M,null),f.uniforms.shadow_pass.value=b.mapPass.texture,f.uniforms.resolution.value.set(b.map.width,b.map.height),f.uniforms.radius.value=b.radius,i.setRenderTarget(b.map),i.clear(),i.renderBufferDirect(C,null,x,f,M,null)}function E(b,C,x,w){let I=null,P=x.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(P!==void 0)I=P;else if(I=x.isPointLight===!0?l:o,i.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){let O=I.uuid,B=C.uuid,L=c[O];L===void 0&&(L={},c[O]=L);let z=L[B];z===void 0&&(z=I.clone(),L[B]=z,C.addEventListener("dispose",S)),I=z}if(I.visible=C.visible,I.wireframe=C.wireframe,w===qi?I.side=C.shadowSide!==null?C.shadowSide:C.side:I.side=C.shadowSide!==null?C.shadowSide:d[C.side],I.alphaMap=C.alphaMap,I.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,I.map=C.map,I.clipShadows=C.clipShadows,I.clippingPlanes=C.clippingPlanes,I.clipIntersection=C.clipIntersection,I.displacementMap=C.displacementMap,I.displacementScale=C.displacementScale,I.displacementBias=C.displacementBias,I.wireframeLinewidth=C.wireframeLinewidth,I.linewidth=C.linewidth,x.isPointLight===!0&&I.isMeshDistanceMaterial===!0){let O=i.properties.get(I);O.light=x}return I}function v(b,C,x,w,I){if(b.visible===!1)return;if(b.layers.test(C.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&I===qi)&&(!b.frustumCulled||b.intersectsFrustum(n))){b.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,b.matrixWorld);let B=t.update(b),L=b.material;if(Array.isArray(L)){let z=B.groups;for(let q=0,Y=z.length;q<Y;q++){let tt=z[q],X=L[tt.materialIndex];if(X&&X.visible){let V=E(b,X,w,I);b.onBeforeShadow(i,b,C,x,B,V,tt),i.renderBufferDirect(x,null,B,V,b,tt),b.onAfterShadow(i,b,C,x,B,V,tt)}}}else if(L.visible){let z=E(b,L,w,I);b.onBeforeShadow(i,b,C,x,B,z,null),i.renderBufferDirect(x,null,B,z,b,null),b.onAfterShadow(i,b,C,x,B,z,null)}}let O=b.children;for(let B=0,L=O.length;B<L;B++)v(O[B],C,x,w,I)}function S(b){b.target.removeEventListener("dispose",S);for(let x in c){let w=c[x],I=b.target.uuid;I in w&&(w[I].dispose(),delete w[I])}}}function a0(i,t){function e(){let F=!1,dt=new me,j=null,gt=new me(0,0,0,0);return{setMask:function(bt){j!==bt&&!F&&(i.colorMask(bt,bt,bt,bt),j=bt)},setLocked:function(bt){F=bt},setClear:function(bt,st,Ot,Lt,he){he===!0&&(bt*=Lt,st*=Lt,Ot*=Lt),dt.set(bt,st,Ot,Lt),gt.equals(dt)===!1&&(i.clearColor(bt,st,Ot,Lt),gt.copy(dt))},reset:function(){F=!1,j=null,gt.set(-1,0,0,0)}}}function n(){let F=!1,dt=!1,j=null,gt=null,bt=null;return{setReversed:function(st){if(dt!==st){let Ot=t.get("EXT_clip_control");st?Ot.clipControlEXT(Ot.LOWER_LEFT_EXT,Ot.ZERO_TO_ONE_EXT):Ot.clipControlEXT(Ot.LOWER_LEFT_EXT,Ot.NEGATIVE_ONE_TO_ONE_EXT),dt=st;let Lt=bt;bt=null,this.setClear(Lt)}},getReversed:function(){return dt},setTest:function(st){st?it(i.DEPTH_TEST):xt(i.DEPTH_TEST)},setMask:function(st){j!==st&&!F&&(i.depthMask(st),j=st)},setFunc:function(st){if(dt&&(st=mh[st]),gt!==st){switch(st){case Cr:i.depthFunc(i.NEVER);break;case Rr:i.depthFunc(i.ALWAYS);break;case Ir:i.depthFunc(i.LESS);break;case Li:i.depthFunc(i.LEQUAL);break;case Pr:i.depthFunc(i.EQUAL);break;case Lr:i.depthFunc(i.GEQUAL);break;case Dr:i.depthFunc(i.GREATER);break;case Nr:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}gt=st}},setLocked:function(st){F=st},setClear:function(st){bt!==st&&(bt=st,dt&&(st=1-st),i.clearDepth(st))},reset:function(){F=!1,j=null,gt=null,bt=null,dt=!1}}}function s(){let F=!1,dt=null,j=null,gt=null,bt=null,st=null,Ot=null,Lt=null,he=null;return{setTest:function(ie){F||(ie?it(i.STENCIL_TEST):xt(i.STENCIL_TEST))},setMask:function(ie){dt!==ie&&!F&&(i.stencilMask(ie),dt=ie)},setFunc:function(ie,tn,un){(j!==ie||gt!==tn||bt!==un)&&(i.stencilFunc(ie,tn,un),j=ie,gt=tn,bt=un)},setOp:function(ie,tn,un){(st!==ie||Ot!==tn||Lt!==un)&&(i.stencilOp(ie,tn,un),st=ie,Ot=tn,Lt=un)},setLocked:function(ie){F=ie},setClear:function(ie){he!==ie&&(i.clearStencil(ie),he=ie)},reset:function(){F=!1,dt=null,j=null,gt=null,bt=null,st=null,Ot=null,Lt=null,he=null}}}let r=new e,a=new n,o=new s,l=new WeakMap,c=new WeakMap,h={},d={},u={},f=new WeakMap,g=[],M=null,m=!1,p=null,A=null,E=null,v=null,S=null,b=null,C=null,x=new qt(0,0,0),w=0,I=!1,P=null,O=null,B=null,L=null,z=null,q=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS),Y=!1,tt=0,X=i.getParameter(i.VERSION);X.indexOf("WebGL")!==-1?(tt=parseFloat(/^WebGL (\d)/.exec(X)[1]),Y=tt>=1):X.indexOf("OpenGL ES")!==-1&&(tt=parseFloat(/^OpenGL ES (\d)/.exec(X)[1]),Y=tt>=2);let V=null,W={},lt=i.getParameter(i.SCISSOR_BOX),_t=i.getParameter(i.VIEWPORT),Yt=new me().fromArray(lt),Zt=new me().fromArray(_t);function jt(F,dt,j,gt){let bt=new Uint8Array(4),st=i.createTexture();i.bindTexture(F,st),i.texParameteri(F,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(F,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Ot=0;Ot<j;Ot++)F===i.TEXTURE_3D||F===i.TEXTURE_2D_ARRAY?i.texImage3D(dt,0,i.RGBA,1,1,gt,0,i.RGBA,i.UNSIGNED_BYTE,bt):i.texImage2D(dt+Ot,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,bt);return st}let K={};K[i.TEXTURE_2D]=jt(i.TEXTURE_2D,i.TEXTURE_2D,1),K[i.TEXTURE_CUBE_MAP]=jt(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),K[i.TEXTURE_2D_ARRAY]=jt(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),K[i.TEXTURE_3D]=jt(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),it(i.DEPTH_TEST),a.setFunc(Li),at(!1),ht(Qo),it(i.CULL_FACE),Q(vn);function it(F){h[F]!==!0&&(i.enable(F),h[F]=!0)}function xt(F){h[F]!==!1&&(i.disable(F),h[F]=!1)}function zt(F,dt){return u[F]!==dt?(i.bindFramebuffer(F,dt),u[F]=dt,F===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=dt),F===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=dt),!0):!1}function St(F,dt){let j=g,gt=!1;if(F){j=f.get(dt),j===void 0&&(j=[],f.set(dt,j));let bt=F.textures;if(j.length!==bt.length||j[0]!==i.COLOR_ATTACHMENT0){for(let st=0,Ot=bt.length;st<Ot;st++)j[st]=i.COLOR_ATTACHMENT0+st;j.length=bt.length,gt=!0}}else j[0]!==i.BACK&&(j[0]=i.BACK,gt=!0);gt&&i.drawBuffers(j)}function kt(F){return M!==F?(i.useProgram(F),M=F,!0):!1}let ne={[di]:i.FUNC_ADD,[Fc]:i.FUNC_SUBTRACT,[Oc]:i.FUNC_REVERSE_SUBTRACT};ne[Bc]=i.MIN,ne[zc]=i.MAX;let et={[Vc]:i.ZERO,[kc]:i.ONE,[Gc]:i.SRC_COLOR,[el]:i.SRC_ALPHA,[Zc]:i.SRC_ALPHA_SATURATE,[qc]:i.DST_COLOR,[Wc]:i.DST_ALPHA,[Hc]:i.ONE_MINUS_SRC_COLOR,[nl]:i.ONE_MINUS_SRC_ALPHA,[Yc]:i.ONE_MINUS_DST_COLOR,[Xc]:i.ONE_MINUS_DST_ALPHA,[Jc]:i.CONSTANT_COLOR,[$c]:i.ONE_MINUS_CONSTANT_COLOR,[Kc]:i.CONSTANT_ALPHA,[Qc]:i.ONE_MINUS_CONSTANT_ALPHA};function Q(F,dt,j,gt,bt,st,Ot,Lt,he,ie){if(F===vn){m===!0&&(xt(i.BLEND),m=!1);return}if(m===!1&&(it(i.BLEND),m=!0),F!==Uc){if(F!==p||ie!==I){if((A!==di||S!==di)&&(i.blendEquation(i.FUNC_ADD),A=di,S=di),ie)switch(F){case Yi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Zi:i.blendFunc(i.ONE,i.ONE);break;case jo:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case tl:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Ht("WebGLState: Invalid blending: ",F);break}else switch(F){case Yi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Zi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case jo:Ht("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case tl:Ht("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ht("WebGLState: Invalid blending: ",F);break}E=null,v=null,b=null,C=null,x.set(0,0,0),w=0,p=F,I=ie}return}bt=bt||dt,st=st||j,Ot=Ot||gt,(dt!==A||bt!==S)&&(i.blendEquationSeparate(ne[dt],ne[bt]),A=dt,S=bt),(j!==E||gt!==v||st!==b||Ot!==C)&&(i.blendFuncSeparate(et[j],et[gt],et[st],et[Ot]),E=j,v=gt,b=st,C=Ot),(Lt.equals(x)===!1||he!==w)&&(i.blendColor(Lt.r,Lt.g,Lt.b,he),x.copy(Lt),w=he),p=F,I=!1}function rt(F,dt){F.side===Je?xt(i.CULL_FACE):it(i.CULL_FACE);let j=F.side===ze;dt&&(j=!j),at(j),F.blending===Yi&&F.transparent===!1?Q(vn):Q(F.blending,F.blendEquation,F.blendSrc,F.blendDst,F.blendEquationAlpha,F.blendSrcAlpha,F.blendDstAlpha,F.blendColor,F.blendAlpha,F.premultipliedAlpha),a.setFunc(F.depthFunc),a.setTest(F.depthTest),a.setMask(F.depthWrite),r.setMask(F.colorWrite);let gt=F.stencilWrite;o.setTest(gt),gt&&(o.setMask(F.stencilWriteMask),o.setFunc(F.stencilFunc,F.stencilRef,F.stencilFuncMask),o.setOp(F.stencilFail,F.stencilZFail,F.stencilZPass)),Ut(F.polygonOffset,F.polygonOffsetFactor,F.polygonOffsetUnits),F.alphaToCoverage===!0?it(i.SAMPLE_ALPHA_TO_COVERAGE):xt(i.SAMPLE_ALPHA_TO_COVERAGE)}function at(F){P!==F&&(F?i.frontFace(i.CW):i.frontFace(i.CCW),P=F)}function ht(F){F!==Lc?(it(i.CULL_FACE),F!==O&&(F===Qo?i.cullFace(i.BACK):F===Dc?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):xt(i.CULL_FACE),O=F}function Bt(F){F!==B&&(Y&&i.lineWidth(F),B=F)}function Ut(F,dt,j){F?(it(i.POLYGON_OFFSET_FILL),(L!==dt||z!==j)&&(L=dt,z=j,a.getReversed()&&(dt=-dt),i.polygonOffset(dt,j))):xt(i.POLYGON_OFFSET_FILL)}function Gt(F){F?it(i.SCISSOR_TEST):xt(i.SCISSOR_TEST)}function Tt(F){F===void 0&&(F=i.TEXTURE0+q-1),V!==F&&(i.activeTexture(F),V=F)}function R(F,dt,j){j===void 0&&(V===null?j=i.TEXTURE0+q-1:j=V);let gt=W[j];gt===void 0&&(gt={type:void 0,texture:void 0},W[j]=gt),(gt.type!==F||gt.texture!==dt)&&(V!==j&&(i.activeTexture(j),V=j),i.bindTexture(F,dt||K[F]),gt.type=F,gt.texture=dt)}function Et(){let F=W[V];F!==void 0&&F.type!==void 0&&(i.bindTexture(F.type,null),F.type=void 0,F.texture=void 0)}function Pt(){try{i.compressedTexImage2D(...arguments)}catch(F){Ht("WebGLState:",F)}}function T(){try{i.compressedTexImage3D(...arguments)}catch(F){Ht("WebGLState:",F)}}function _(){try{i.texSubImage2D(...arguments)}catch(F){Ht("WebGLState:",F)}}function U(){try{i.texSubImage3D(...arguments)}catch(F){Ht("WebGLState:",F)}}function k(){try{i.compressedTexSubImage2D(...arguments)}catch(F){Ht("WebGLState:",F)}}function J(){try{i.compressedTexSubImage3D(...arguments)}catch(F){Ht("WebGLState:",F)}}function ot(){try{i.texStorage2D(...arguments)}catch(F){Ht("WebGLState:",F)}}function ut(){try{i.texStorage3D(...arguments)}catch(F){Ht("WebGLState:",F)}}function $(){try{i.texImage2D(...arguments)}catch(F){Ht("WebGLState:",F)}}function nt(){try{i.texImage3D(...arguments)}catch(F){Ht("WebGLState:",F)}}function pt(F){return d[F]!==void 0?d[F]:i.getParameter(F)}function Ct(F,dt){d[F]!==dt&&(i.pixelStorei(F,dt),d[F]=dt)}function ft(F){Yt.equals(F)===!1&&(i.scissor(F.x,F.y,F.z,F.w),Yt.copy(F))}function mt(F){Zt.equals(F)===!1&&(i.viewport(F.x,F.y,F.z,F.w),Zt.copy(F))}function Dt(F,dt){let j=c.get(dt);j===void 0&&(j=new WeakMap,c.set(dt,j));let gt=j.get(F);gt===void 0&&(gt=i.getUniformBlockIndex(dt,F.name),j.set(F,gt))}function Ft(F,dt){let gt=c.get(dt).get(F);l.get(dt)!==gt&&(i.uniformBlockBinding(dt,gt,F.__bindingPointIndex),l.set(dt,gt))}function Xt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),h={},d={},V=null,W={},u={},f=new WeakMap,g=[],M=null,m=!1,p=null,A=null,E=null,v=null,S=null,b=null,C=null,x=new qt(0,0,0),w=0,I=!1,P=null,O=null,B=null,L=null,z=null,Yt.set(0,0,i.canvas.width,i.canvas.height),Zt.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:it,disable:xt,bindFramebuffer:zt,drawBuffers:St,useProgram:kt,setBlending:Q,setMaterial:rt,setFlipSided:at,setCullFace:ht,setLineWidth:Bt,setPolygonOffset:Ut,setScissorTest:Gt,activeTexture:Tt,bindTexture:R,unbindTexture:Et,compressedTexImage2D:Pt,compressedTexImage3D:T,texImage2D:$,texImage3D:nt,pixelStorei:Ct,getParameter:pt,updateUBOMapping:Dt,uniformBlockBinding:Ft,texStorage2D:ot,texStorage3D:ut,texSubImage2D:_,texSubImage3D:U,compressedTexSubImage2D:k,compressedTexSubImage3D:J,scissor:ft,viewport:mt,reset:Xt}}function o0(i,t,e,n,s,r,a){let o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new ct,h=new WeakMap,d=new Set,u,f=new WeakMap,g=!1;try{g=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function M(T,_){return g?new OffscreenCanvas(T,_):xs("canvas")}function m(T,_,U){let k=1,J=Pt(T);if((J.width>U||J.height>U)&&(k=U/Math.max(J.width,J.height)),k<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){let ot=Math.floor(k*J.width),ut=Math.floor(k*J.height);u===void 0&&(u=M(ot,ut));let $=_?M(ot,ut):u;return $.width=ot,$.height=ut,$.getContext("2d").drawImage(T,0,0,ot,ut),Vt("WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+ot+"x"+ut+")."),$}else return"data"in T&&Vt("WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),T;return T}function p(T){return T.generateMipmaps}function A(T){i.generateMipmap(T)}function E(T){return T.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?i.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function v(T,_,U,k,J,ot=!1){if(T!==null){if(i[T]!==void 0)return i[T];Vt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let ut;k&&(ut=t.get("EXT_texture_norm16"),ut||Vt("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let $=_;if(_===i.RED&&(U===i.FLOAT&&($=i.R32F),U===i.HALF_FLOAT&&($=i.R16F),U===i.UNSIGNED_BYTE&&($=i.R8),U===i.UNSIGNED_SHORT&&ut&&($=ut.R16_EXT),U===i.SHORT&&ut&&($=ut.R16_SNORM_EXT)),_===i.RED_INTEGER&&(U===i.UNSIGNED_BYTE&&($=i.R8UI),U===i.UNSIGNED_SHORT&&($=i.R16UI),U===i.UNSIGNED_INT&&($=i.R32UI),U===i.BYTE&&($=i.R8I),U===i.SHORT&&($=i.R16I),U===i.INT&&($=i.R32I)),_===i.RG&&(U===i.FLOAT&&($=i.RG32F),U===i.HALF_FLOAT&&($=i.RG16F),U===i.UNSIGNED_BYTE&&($=i.RG8),U===i.UNSIGNED_SHORT&&ut&&($=ut.RG16_EXT),U===i.SHORT&&ut&&($=ut.RG16_SNORM_EXT)),_===i.RG_INTEGER&&(U===i.UNSIGNED_BYTE&&($=i.RG8UI),U===i.UNSIGNED_SHORT&&($=i.RG16UI),U===i.UNSIGNED_INT&&($=i.RG32UI),U===i.BYTE&&($=i.RG8I),U===i.SHORT&&($=i.RG16I),U===i.INT&&($=i.RG32I)),_===i.RGB_INTEGER&&(U===i.UNSIGNED_BYTE&&($=i.RGB8UI),U===i.UNSIGNED_SHORT&&($=i.RGB16UI),U===i.UNSIGNED_INT&&($=i.RGB32UI),U===i.BYTE&&($=i.RGB8I),U===i.SHORT&&($=i.RGB16I),U===i.INT&&($=i.RGB32I)),_===i.RGBA_INTEGER&&(U===i.UNSIGNED_BYTE&&($=i.RGBA8UI),U===i.UNSIGNED_SHORT&&($=i.RGBA16UI),U===i.UNSIGNED_INT&&($=i.RGBA32UI),U===i.BYTE&&($=i.RGBA8I),U===i.SHORT&&($=i.RGBA16I),U===i.INT&&($=i.RGBA32I)),_===i.RGB&&(U===i.UNSIGNED_SHORT&&ut&&($=ut.RGB16_EXT),U===i.SHORT&&ut&&($=ut.RGB16_SNORM_EXT),U===i.UNSIGNED_INT_5_9_9_9_REV&&($=i.RGB9_E5),U===i.UNSIGNED_INT_10F_11F_11F_REV&&($=i.R11F_G11F_B10F)),_===i.RGBA){let nt=ot?_s:te.getTransfer(J);U===i.FLOAT&&($=i.RGBA32F),U===i.HALF_FLOAT&&($=i.RGBA16F),U===i.UNSIGNED_BYTE&&($=nt===re?i.SRGB8_ALPHA8:i.RGBA8),U===i.UNSIGNED_SHORT&&ut&&($=ut.RGBA16_EXT),U===i.SHORT&&ut&&($=ut.RGBA16_SNORM_EXT),U===i.UNSIGNED_SHORT_4_4_4_4&&($=i.RGBA4),U===i.UNSIGNED_SHORT_5_5_5_1&&($=i.RGB5_A1)}return($===i.R16F||$===i.R32F||$===i.RG16F||$===i.RG32F||$===i.RGBA16F||$===i.RGBA32F)&&t.get("EXT_color_buffer_float"),$}function S(T,_){let U;return T?_===null||_===on||_===Ki?U=i.DEPTH24_STENCIL8:_===ln?U=i.DEPTH32F_STENCIL8:_===$i&&(U=i.DEPTH24_STENCIL8,Vt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):_===null||_===on||_===Ki?U=i.DEPTH_COMPONENT24:_===ln?U=i.DEPTH_COMPONENT32F:_===$i&&(U=i.DEPTH_COMPONENT16),U}function b(T,_){return p(T)===!0||T.isFramebufferTexture&&T.minFilter!==Ae&&T.minFilter!==Ce?Math.log2(Math.max(_.width,_.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?_.mipmaps.length:1}function C(T){let _=T.target;_.removeEventListener("dispose",C),w(_),_.isVideoTexture&&h.delete(_),_.isHTMLTexture&&d.delete(_)}function x(T){let _=T.target;_.removeEventListener("dispose",x),P(_)}function w(T){let _=n.get(T);if(_.__webglInit===void 0)return;let U=T.source,k=f.get(U);if(k){let J=k[_.__cacheKey];J.usedTimes--,J.usedTimes===0&&I(T),Object.keys(k).length===0&&f.delete(U)}n.remove(T)}function I(T){let _=n.get(T);i.deleteTexture(_.__webglTexture);let U=T.source,k=f.get(U);delete k[_.__cacheKey],a.memory.textures--}function P(T){let _=n.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),n.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let k=0;k<6;k++){if(Array.isArray(_.__webglFramebuffer[k]))for(let J=0;J<_.__webglFramebuffer[k].length;J++)i.deleteFramebuffer(_.__webglFramebuffer[k][J]);else i.deleteFramebuffer(_.__webglFramebuffer[k]);_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer[k])}else{if(Array.isArray(_.__webglFramebuffer))for(let k=0;k<_.__webglFramebuffer.length;k++)i.deleteFramebuffer(_.__webglFramebuffer[k]);else i.deleteFramebuffer(_.__webglFramebuffer);if(_.__webglDepthbuffer&&i.deleteRenderbuffer(_.__webglDepthbuffer),_.__webglMultisampledFramebuffer&&i.deleteFramebuffer(_.__webglMultisampledFramebuffer),_.__webglColorRenderbuffer)for(let k=0;k<_.__webglColorRenderbuffer.length;k++)_.__webglColorRenderbuffer[k]&&i.deleteRenderbuffer(_.__webglColorRenderbuffer[k]);_.__webglDepthRenderbuffer&&i.deleteRenderbuffer(_.__webglDepthRenderbuffer)}let U=T.textures;for(let k=0,J=U.length;k<J;k++){let ot=n.get(U[k]);ot.__webglTexture&&(i.deleteTexture(ot.__webglTexture),a.memory.textures--),n.remove(U[k])}n.remove(T)}let O=0;function B(){O=0}function L(){return O}function z(T){O=T}function q(){let T=O;return T>=s.maxTextures&&Vt("WebGLTextures: Trying to use "+(T+1)+" texture units while this GPU supports only "+s.maxTextures),O+=1,T}function Y(T){let _=[];return _.push(T.wrapS),_.push(T.wrapT),_.push(T.wrapR||0),_.push(T.magFilter),_.push(T.minFilter),_.push(T.anisotropy),_.push(T.internalFormat),_.push(T.format),_.push(T.type),_.push(T.generateMipmaps),_.push(T.premultiplyAlpha),_.push(T.flipY),_.push(T.unpackAlignment),_.push(T.colorSpace),_.join()}function tt(T,_){let U=n.get(T);if(T.isVideoTexture&&R(T),T.isRenderTargetTexture===!1&&T.isExternalTexture!==!0&&T.version>0&&U.__version!==T.version){let k=T.image;if(k===null)Vt("WebGLRenderer: Texture marked for update but no image data found.");else if(k.complete===!1)Vt("WebGLRenderer: Texture marked for update but image is incomplete");else{xt(U,T,_);return}}else T.isExternalTexture&&(U.__webglTexture=T.sourceTexture?T.sourceTexture:null);e.bindTexture(i.TEXTURE_2D,U.__webglTexture,i.TEXTURE0+_)}function X(T,_){let U=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&U.__version!==T.version){xt(U,T,_);return}else T.isExternalTexture&&(U.__webglTexture=T.sourceTexture?T.sourceTexture:null);e.bindTexture(i.TEXTURE_2D_ARRAY,U.__webglTexture,i.TEXTURE0+_)}function V(T,_){let U=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&U.__version!==T.version){xt(U,T,_);return}e.bindTexture(i.TEXTURE_3D,U.__webglTexture,i.TEXTURE0+_)}function W(T,_){let U=n.get(T);if(T.isCubeDepthTexture!==!0&&T.version>0&&U.__version!==T.version){zt(U,T,_);return}e.bindTexture(i.TEXTURE_CUBE_MAP,U.__webglTexture,i.TEXTURE0+_)}let lt={[Di]:i.REPEAT,[pn]:i.CLAMP_TO_EDGE,[Ur]:i.MIRRORED_REPEAT},_t={[Ae]:i.NEAREST,[eh]:i.NEAREST_MIPMAP_NEAREST,[Gs]:i.NEAREST_MIPMAP_LINEAR,[Ce]:i.LINEAR,[xa]:i.LINEAR_MIPMAP_NEAREST,[jn]:i.LINEAR_MIPMAP_LINEAR},Yt={[rh]:i.NEVER,[hh]:i.ALWAYS,[ah]:i.LESS,[no]:i.LEQUAL,[oh]:i.EQUAL,[io]:i.GEQUAL,[lh]:i.GREATER,[ch]:i.NOTEQUAL};function Zt(T,_){if(_.type===ln&&t.has("OES_texture_float_linear")===!1&&(_.magFilter===Ce||_.magFilter===xa||_.magFilter===Gs||_.magFilter===jn||_.minFilter===Ce||_.minFilter===xa||_.minFilter===Gs||_.minFilter===jn)&&Vt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(T,i.TEXTURE_WRAP_S,lt[_.wrapS]),i.texParameteri(T,i.TEXTURE_WRAP_T,lt[_.wrapT]),(T===i.TEXTURE_3D||T===i.TEXTURE_2D_ARRAY)&&i.texParameteri(T,i.TEXTURE_WRAP_R,lt[_.wrapR]),i.texParameteri(T,i.TEXTURE_MAG_FILTER,_t[_.magFilter]),i.texParameteri(T,i.TEXTURE_MIN_FILTER,_t[_.minFilter]),_.compareFunction&&(i.texParameteri(T,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(T,i.TEXTURE_COMPARE_FUNC,Yt[_.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(_.magFilter===Ae||_.minFilter!==Gs&&_.minFilter!==jn||_.type===ln&&t.has("OES_texture_float_linear")===!1)return;if(_.anisotropy>1||n.get(_).__currentAnisotropy){let U=t.get("EXT_texture_filter_anisotropic");i.texParameterf(T,U.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(_.anisotropy,s.getMaxAnisotropy())),n.get(_).__currentAnisotropy=_.anisotropy}}}function jt(T,_){let U=!1;T.__webglInit===void 0&&(T.__webglInit=!0,_.addEventListener("dispose",C));let k=_.source,J=f.get(k);J===void 0&&(J={},f.set(k,J));let ot=Y(_);if(ot!==T.__cacheKey){J[ot]===void 0&&(J[ot]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,U=!0),J[ot].usedTimes++;let ut=J[T.__cacheKey];ut!==void 0&&(J[T.__cacheKey].usedTimes--,ut.usedTimes===0&&I(_)),T.__cacheKey=ot,T.__webglTexture=J[ot].texture}return U}function K(T,_,U){return Math.floor(Math.floor(T/U)/_)}function it(T,_,U,k){let ot=T.updateRanges;if(ot.length===0)e.texSubImage2D(i.TEXTURE_2D,0,0,0,_.width,_.height,U,k,_.data);else{ot.sort((Ct,ft)=>Ct.start-ft.start);let ut=0;for(let Ct=1;Ct<ot.length;Ct++){let ft=ot[ut],mt=ot[Ct],Dt=ft.start+ft.count,Ft=K(mt.start,_.width,4),Xt=K(ft.start,_.width,4);mt.start<=Dt+1&&Ft===Xt&&K(mt.start+mt.count-1,_.width,4)===Ft?ft.count=Math.max(ft.count,mt.start+mt.count-ft.start):(++ut,ot[ut]=mt)}ot.length=ut+1;let $=e.getParameter(i.UNPACK_ROW_LENGTH),nt=e.getParameter(i.UNPACK_SKIP_PIXELS),pt=e.getParameter(i.UNPACK_SKIP_ROWS);e.pixelStorei(i.UNPACK_ROW_LENGTH,_.width);for(let Ct=0,ft=ot.length;Ct<ft;Ct++){let mt=ot[Ct],Dt=Math.floor(mt.start/4),Ft=Math.ceil(mt.count/4),Xt=Dt%_.width,F=Math.floor(Dt/_.width),dt=Ft,j=1;e.pixelStorei(i.UNPACK_SKIP_PIXELS,Xt),e.pixelStorei(i.UNPACK_SKIP_ROWS,F),e.texSubImage2D(i.TEXTURE_2D,0,Xt,F,dt,j,U,k,_.data)}T.clearUpdateRanges(),e.pixelStorei(i.UNPACK_ROW_LENGTH,$),e.pixelStorei(i.UNPACK_SKIP_PIXELS,nt),e.pixelStorei(i.UNPACK_SKIP_ROWS,pt)}}function xt(T,_,U){let k=i.TEXTURE_2D;(_.isDataArrayTexture||_.isCompressedArrayTexture)&&(k=i.TEXTURE_2D_ARRAY),_.isData3DTexture&&(k=i.TEXTURE_3D);let J=jt(T,_),ot=_.source;e.bindTexture(k,T.__webglTexture,i.TEXTURE0+U);let ut=n.get(ot);if(ot.version!==ut.__version||J===!0){if(e.activeTexture(i.TEXTURE0+U),(typeof ImageBitmap<"u"&&_.image instanceof ImageBitmap)===!1){let j=te.getPrimaries(te.workingColorSpace),gt=_.colorSpace===Dn?null:te.getPrimaries(_.colorSpace),bt=_.colorSpace===Dn||j===gt?i.NONE:i.BROWSER_DEFAULT_WEBGL;e.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),e.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),e.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,bt)}e.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment);let nt=m(_.image,!1,s.maxTextureSize);nt=Et(_,nt);let pt=r.convert(_.format,_.colorSpace),Ct=r.convert(_.type),ft=v(_.internalFormat,pt,Ct,_.normalized,_.colorSpace,_.isVideoTexture);Zt(k,_);let mt,Dt=_.mipmaps,Ft=_.isVideoTexture!==!0,Xt=ut.__version===void 0||J===!0,F=ot.dataReady,dt=b(_,nt);if(_.isDepthTexture)ft=S(_.format===ti,_.type),Xt&&(Ft?e.texStorage2D(i.TEXTURE_2D,1,ft,nt.width,nt.height):e.texImage2D(i.TEXTURE_2D,0,ft,nt.width,nt.height,0,pt,Ct,null));else if(_.isDataTexture)if(Dt.length>0){Ft&&Xt&&e.texStorage2D(i.TEXTURE_2D,dt,ft,Dt[0].width,Dt[0].height);for(let j=0,gt=Dt.length;j<gt;j++)mt=Dt[j],Ft?F&&e.texSubImage2D(i.TEXTURE_2D,j,0,0,mt.width,mt.height,pt,Ct,mt.data):e.texImage2D(i.TEXTURE_2D,j,ft,mt.width,mt.height,0,pt,Ct,mt.data);_.generateMipmaps=!1}else Ft?(Xt&&e.texStorage2D(i.TEXTURE_2D,dt,ft,nt.width,nt.height),F&&it(_,nt,pt,Ct)):e.texImage2D(i.TEXTURE_2D,0,ft,nt.width,nt.height,0,pt,Ct,nt.data);else if(_.isCompressedTexture)if(_.isCompressedArrayTexture){Ft&&Xt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,dt,ft,Dt[0].width,Dt[0].height,nt.depth);for(let j=0,gt=Dt.length;j<gt;j++)if(mt=Dt[j],_.format!==je)if(pt!==null)if(Ft){if(F)if(_.layerUpdates.size>0){let bt=Tl(mt.width,mt.height,_.format,_.type);for(let st of _.layerUpdates){let Ot=mt.data.subarray(st*bt/mt.data.BYTES_PER_ELEMENT,(st+1)*bt/mt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,j,0,0,st,mt.width,mt.height,1,pt,Ot)}}else e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,j,0,0,0,mt.width,mt.height,nt.depth,pt,mt.data)}else e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,j,ft,mt.width,mt.height,nt.depth,0,mt.data,0,0);else Vt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ft?F&&e.texSubImage3D(i.TEXTURE_2D_ARRAY,j,0,0,0,mt.width,mt.height,nt.depth,pt,Ct,mt.data):e.texImage3D(i.TEXTURE_2D_ARRAY,j,ft,mt.width,mt.height,nt.depth,0,pt,Ct,mt.data);_.layerUpdates.size>0&&_.clearLayerUpdates()}else{Ft&&Xt&&e.texStorage2D(i.TEXTURE_2D,dt,ft,Dt[0].width,Dt[0].height);for(let j=0,gt=Dt.length;j<gt;j++)mt=Dt[j],_.format!==je?pt!==null?Ft?F&&e.compressedTexSubImage2D(i.TEXTURE_2D,j,0,0,mt.width,mt.height,pt,mt.data):e.compressedTexImage2D(i.TEXTURE_2D,j,ft,mt.width,mt.height,0,mt.data):Vt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ft?F&&e.texSubImage2D(i.TEXTURE_2D,j,0,0,mt.width,mt.height,pt,Ct,mt.data):e.texImage2D(i.TEXTURE_2D,j,ft,mt.width,mt.height,0,pt,Ct,mt.data)}else if(_.isDataArrayTexture)if(Ft){if(Xt&&e.texStorage3D(i.TEXTURE_2D_ARRAY,dt,ft,nt.width,nt.height,nt.depth),F)if(_.layerUpdates.size>0){let j=Tl(nt.width,nt.height,_.format,_.type);for(let gt of _.layerUpdates){let bt=nt.data.subarray(gt*j/nt.data.BYTES_PER_ELEMENT,(gt+1)*j/nt.data.BYTES_PER_ELEMENT);e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,gt,nt.width,nt.height,1,pt,Ct,bt)}_.clearLayerUpdates()}else e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,nt.width,nt.height,nt.depth,pt,Ct,nt.data)}else e.texImage3D(i.TEXTURE_2D_ARRAY,0,ft,nt.width,nt.height,nt.depth,0,pt,Ct,nt.data);else if(_.isData3DTexture)Ft?(Xt&&e.texStorage3D(i.TEXTURE_3D,dt,ft,nt.width,nt.height,nt.depth),F&&e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,nt.width,nt.height,nt.depth,pt,Ct,nt.data)):e.texImage3D(i.TEXTURE_3D,0,ft,nt.width,nt.height,nt.depth,0,pt,Ct,nt.data);else if(_.isFramebufferTexture){if(Xt)if(Ft)e.texStorage2D(i.TEXTURE_2D,dt,ft,nt.width,nt.height);else{let j=nt.width,gt=nt.height;for(let bt=0;bt<dt;bt++)e.texImage2D(i.TEXTURE_2D,bt,ft,j,gt,0,pt,Ct,null),j>>=1,gt>>=1}}else if(_.isHTMLTexture){if("texElementImage2D"in i){let j=i.canvas;if(j.hasAttribute("layoutsubtree")||j.setAttribute("layoutsubtree","true"),nt.parentNode!==j){j.appendChild(nt),d.add(_),j.onpaint=gt=>{let bt=gt.changedElements;for(let st of d)bt.includes(st.image)&&(st.needsUpdate=!0)},j.requestPaint();return}if(i.texElementImage2D.length===3)i.texElementImage2D(i.TEXTURE_2D,i.RGBA8,nt);else{let bt=i.RGBA,st=i.RGBA,Ot=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,0,bt,st,Ot,nt)}i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Dt.length>0){if(Ft&&Xt){let j=Pt(Dt[0]);e.texStorage2D(i.TEXTURE_2D,dt,ft,j.width,j.height)}for(let j=0,gt=Dt.length;j<gt;j++)mt=Dt[j],Ft?F&&e.texSubImage2D(i.TEXTURE_2D,j,0,0,pt,Ct,mt):e.texImage2D(i.TEXTURE_2D,j,ft,pt,Ct,mt);_.generateMipmaps=!1}else if(Ft){if(Xt){let j=Pt(nt);e.texStorage2D(i.TEXTURE_2D,dt,ft,j.width,j.height)}F&&e.texSubImage2D(i.TEXTURE_2D,0,0,0,pt,Ct,nt)}else e.texImage2D(i.TEXTURE_2D,0,ft,pt,Ct,nt);p(_)&&A(k),ut.__version=ot.version,_.onUpdate&&_.onUpdate(_)}T.__version=_.version}function zt(T,_,U){if(_.image.length!==6)return;let k=jt(T,_),J=_.source;e.bindTexture(i.TEXTURE_CUBE_MAP,T.__webglTexture,i.TEXTURE0+U);let ot=n.get(J);if(J.version!==ot.__version||k===!0){e.activeTexture(i.TEXTURE0+U);let ut=te.getPrimaries(te.workingColorSpace),$=_.colorSpace===Dn?null:te.getPrimaries(_.colorSpace),nt=_.colorSpace===Dn||ut===$?i.NONE:i.BROWSER_DEFAULT_WEBGL;e.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,_.flipY),e.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,_.premultiplyAlpha),e.pixelStorei(i.UNPACK_ALIGNMENT,_.unpackAlignment),e.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,nt);let pt=_.isCompressedTexture||_.image[0].isCompressedTexture,Ct=_.image[0]&&_.image[0].isDataTexture,ft=[];for(let st=0;st<6;st++)!pt&&!Ct?ft[st]=m(_.image[st],!0,s.maxCubemapSize):ft[st]=Ct?_.image[st].image:_.image[st],ft[st]=Et(_,ft[st]);let mt=ft[0],Dt=r.convert(_.format,_.colorSpace),Ft=r.convert(_.type),Xt=v(_.internalFormat,Dt,Ft,_.normalized,_.colorSpace),F=_.isVideoTexture!==!0,dt=ot.__version===void 0||k===!0,j=J.dataReady,gt=b(_,mt);Zt(i.TEXTURE_CUBE_MAP,_);let bt;if(pt){F&&dt&&e.texStorage2D(i.TEXTURE_CUBE_MAP,gt,Xt,mt.width,mt.height);for(let st=0;st<6;st++){bt=ft[st].mipmaps;for(let Ot=0;Ot<bt.length;Ot++){let Lt=bt[Ot];_.format!==je?Dt!==null?F?j&&e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+st,Ot,0,0,Lt.width,Lt.height,Dt,Lt.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+st,Ot,Xt,Lt.width,Lt.height,0,Lt.data):Vt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):F?j&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+st,Ot,0,0,Lt.width,Lt.height,Dt,Ft,Lt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+st,Ot,Xt,Lt.width,Lt.height,0,Dt,Ft,Lt.data)}}}else{if(bt=_.mipmaps,F&&dt){bt.length>0&&gt++;let st=Pt(ft[0]);e.texStorage2D(i.TEXTURE_CUBE_MAP,gt,Xt,st.width,st.height)}for(let st=0;st<6;st++)if(Ct){F?j&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+st,0,0,0,ft[st].width,ft[st].height,Dt,Ft,ft[st].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+st,0,Xt,ft[st].width,ft[st].height,0,Dt,Ft,ft[st].data);for(let Ot=0;Ot<bt.length;Ot++){let he=bt[Ot].image[st].image;F?j&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+st,Ot+1,0,0,he.width,he.height,Dt,Ft,he.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+st,Ot+1,Xt,he.width,he.height,0,Dt,Ft,he.data)}}else{F?j&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+st,0,0,0,Dt,Ft,ft[st]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+st,0,Xt,Dt,Ft,ft[st]);for(let Ot=0;Ot<bt.length;Ot++){let Lt=bt[Ot];F?j&&e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+st,Ot+1,0,0,Dt,Ft,Lt.image[st]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+st,Ot+1,Xt,Dt,Ft,Lt.image[st])}}}p(_)&&A(i.TEXTURE_CUBE_MAP),ot.__version=J.version,_.onUpdate&&_.onUpdate(_)}T.__version=_.version}function St(T,_,U,k,J,ot){let ut=r.convert(U.format,U.colorSpace),$=r.convert(U.type),nt=v(U.internalFormat,ut,$,U.normalized,U.colorSpace),pt=n.get(_),Ct=n.get(U);if(Ct.__renderTarget=_,!pt.__hasExternalTextures){let ft=Math.max(1,_.width>>ot),mt=Math.max(1,_.height>>ot);J===i.TEXTURE_3D||J===i.TEXTURE_2D_ARRAY?e.texImage3D(J,ot,nt,ft,mt,_.depth,0,ut,$,null):e.texImage2D(J,ot,nt,ft,mt,0,ut,$,null)}e.bindFramebuffer(i.FRAMEBUFFER,T),Tt(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,k,J,Ct.__webglTexture,0,Gt(_)):(J===i.TEXTURE_2D||J>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,k,J,Ct.__webglTexture,ot),e.bindFramebuffer(i.FRAMEBUFFER,null)}function kt(T,_,U){if(i.bindRenderbuffer(i.RENDERBUFFER,T),_.depthBuffer){let k=_.depthTexture,J=k&&k.isDepthTexture?k.type:null,ot=S(_.stencilBuffer,J),ut=_.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;Tt(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Gt(_),ot,_.width,_.height):U?i.renderbufferStorageMultisample(i.RENDERBUFFER,Gt(_),ot,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,ot,_.width,_.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,ut,i.RENDERBUFFER,T)}else{let k=_.textures;for(let J=0;J<k.length;J++){let ot=k[J],ut=r.convert(ot.format,ot.colorSpace),$=r.convert(ot.type),nt=v(ot.internalFormat,ut,$,ot.normalized,ot.colorSpace);Tt(_)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Gt(_),nt,_.width,_.height):U?i.renderbufferStorageMultisample(i.RENDERBUFFER,Gt(_),nt,_.width,_.height):i.renderbufferStorage(i.RENDERBUFFER,nt,_.width,_.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function ne(T,_,U){let k=_.isWebGLCubeRenderTarget===!0;if(e.bindFramebuffer(i.FRAMEBUFFER,T),!(_.depthTexture&&_.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let J=n.get(_.depthTexture);if(J.__renderTarget=_,(!J.__webglTexture||_.depthTexture.image.width!==_.width||_.depthTexture.image.height!==_.height)&&(_.depthTexture.image.width=_.width,_.depthTexture.image.height=_.height,_.depthTexture.needsUpdate=!0),k){if(J.__webglInit===void 0&&(J.__webglInit=!0,_.depthTexture.addEventListener("dispose",C)),J.__webglTexture===void 0){J.__webglTexture=i.createTexture(),e.bindTexture(i.TEXTURE_CUBE_MAP,J.__webglTexture),Zt(i.TEXTURE_CUBE_MAP,_.depthTexture);let pt=r.convert(_.depthTexture.format),Ct=r.convert(_.depthTexture.type),ft;_.depthTexture.format===mn?ft=i.DEPTH_COMPONENT24:_.depthTexture.format===ti&&(ft=i.DEPTH24_STENCIL8);for(let mt=0;mt<6;mt++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+mt,0,ft,_.width,_.height,0,pt,Ct,null)}}else tt(_.depthTexture,0);let ot=J.__webglTexture,ut=Gt(_),$=k?i.TEXTURE_CUBE_MAP_POSITIVE_X+U:i.TEXTURE_2D,nt=_.depthTexture.format===ti?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(_.depthTexture.format===mn)Tt(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,nt,$,ot,0,ut):i.framebufferTexture2D(i.FRAMEBUFFER,nt,$,ot,0);else if(_.depthTexture.format===ti)Tt(_)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,nt,$,ot,0,ut):i.framebufferTexture2D(i.FRAMEBUFFER,nt,$,ot,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function et(T){let _=n.get(T),U=T.isWebGLCubeRenderTarget===!0;if(_.__boundDepthTexture!==T.depthTexture){let k=T.depthTexture;if(_.__depthDisposeCallback&&_.__depthDisposeCallback(),k){let J=()=>{delete _.__boundDepthTexture,delete _.__depthDisposeCallback,k.removeEventListener("dispose",J)};k.addEventListener("dispose",J),_.__depthDisposeCallback=J}_.__boundDepthTexture=k}if(T.depthTexture&&!_.__autoAllocateDepthBuffer)if(U)for(let k=0;k<6;k++)ne(_.__webglFramebuffer[k],T,k);else{let k=T.texture.mipmaps;k&&k.length>0?ne(_.__webglFramebuffer[0],T,0):ne(_.__webglFramebuffer,T,0)}else if(U){_.__webglDepthbuffer=[];for(let k=0;k<6;k++)if(e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[k]),_.__webglDepthbuffer[k]===void 0)_.__webglDepthbuffer[k]=i.createRenderbuffer(),kt(_.__webglDepthbuffer[k],T,!1);else{let J=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ot=_.__webglDepthbuffer[k];i.bindRenderbuffer(i.RENDERBUFFER,ot),i.framebufferRenderbuffer(i.FRAMEBUFFER,J,i.RENDERBUFFER,ot)}}else{let k=T.texture.mipmaps;if(k&&k.length>0?e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer[0]):e.bindFramebuffer(i.FRAMEBUFFER,_.__webglFramebuffer),_.__webglDepthbuffer===void 0)_.__webglDepthbuffer=i.createRenderbuffer(),kt(_.__webglDepthbuffer,T,!1);else{let J=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ot=_.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,ot),i.framebufferRenderbuffer(i.FRAMEBUFFER,J,i.RENDERBUFFER,ot)}}e.bindFramebuffer(i.FRAMEBUFFER,null)}function Q(T,_,U){let k=n.get(T);_!==void 0&&St(k.__webglFramebuffer,T,T.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),U!==void 0&&et(T)}function rt(T){let _=T.texture,U=n.get(T),k=n.get(_);T.addEventListener("dispose",x);let J=T.textures,ot=T.isWebGLCubeRenderTarget===!0,ut=J.length>1;if(ut||(k.__webglTexture===void 0&&(k.__webglTexture=i.createTexture()),k.__version=_.version,a.memory.textures++),ot){U.__webglFramebuffer=[];for(let $=0;$<6;$++)if(_.mipmaps&&_.mipmaps.length>0){U.__webglFramebuffer[$]=[];for(let nt=0;nt<_.mipmaps.length;nt++)U.__webglFramebuffer[$][nt]=i.createFramebuffer()}else U.__webglFramebuffer[$]=i.createFramebuffer()}else{if(_.mipmaps&&_.mipmaps.length>0){U.__webglFramebuffer=[];for(let $=0;$<_.mipmaps.length;$++)U.__webglFramebuffer[$]=i.createFramebuffer()}else U.__webglFramebuffer=i.createFramebuffer();if(ut)for(let $=0,nt=J.length;$<nt;$++){let pt=n.get(J[$]);pt.__webglTexture===void 0&&(pt.__webglTexture=i.createTexture(),a.memory.textures++)}if(T.samples>0&&Tt(T)===!1){U.__webglMultisampledFramebuffer=i.createFramebuffer(),U.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,U.__webglMultisampledFramebuffer);for(let $=0;$<J.length;$++){let nt=J[$];U.__webglColorRenderbuffer[$]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,U.__webglColorRenderbuffer[$]);let pt=r.convert(nt.format,nt.colorSpace),Ct=r.convert(nt.type),ft=v(nt.internalFormat,pt,Ct,nt.normalized,nt.colorSpace,T.isXRRenderTarget===!0),mt=Gt(T);i.renderbufferStorageMultisample(i.RENDERBUFFER,mt,ft,T.width,T.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+$,i.RENDERBUFFER,U.__webglColorRenderbuffer[$])}i.bindRenderbuffer(i.RENDERBUFFER,null),T.depthBuffer&&(U.__webglDepthRenderbuffer=i.createRenderbuffer(),kt(U.__webglDepthRenderbuffer,T,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(ot){e.bindTexture(i.TEXTURE_CUBE_MAP,k.__webglTexture),Zt(i.TEXTURE_CUBE_MAP,_);for(let $=0;$<6;$++)if(_.mipmaps&&_.mipmaps.length>0)for(let nt=0;nt<_.mipmaps.length;nt++)St(U.__webglFramebuffer[$][nt],T,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+$,nt);else St(U.__webglFramebuffer[$],T,_,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0);p(_)&&A(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(ut){for(let $=0,nt=J.length;$<nt;$++){let pt=J[$],Ct=n.get(pt),ft=i.TEXTURE_2D;(T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(ft=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture(ft,Ct.__webglTexture),Zt(ft,pt),St(U.__webglFramebuffer,T,pt,i.COLOR_ATTACHMENT0+$,ft,0),p(pt)&&A(ft)}e.unbindTexture()}else{let $=i.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&($=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),e.bindTexture($,k.__webglTexture),Zt($,_),_.mipmaps&&_.mipmaps.length>0)for(let nt=0;nt<_.mipmaps.length;nt++)St(U.__webglFramebuffer[nt],T,_,i.COLOR_ATTACHMENT0,$,nt);else St(U.__webglFramebuffer,T,_,i.COLOR_ATTACHMENT0,$,0);p(_)&&A($),e.unbindTexture()}T.depthBuffer&&et(T)}function at(T){let _=T.textures;for(let U=0,k=_.length;U<k;U++){let J=_[U];if(p(J)){let ot=E(T),ut=n.get(J).__webglTexture;e.bindTexture(ot,ut),A(ot),e.unbindTexture()}}}let ht=[],Bt=[];function Ut(T){if(T.samples>0){if(Tt(T)===!1){let _=T.textures,U=T.width,k=T.height,J=i.COLOR_BUFFER_BIT,ot=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ut=n.get(T),$=_.length>1;if($)for(let pt=0;pt<_.length;pt++)e.bindFramebuffer(i.FRAMEBUFFER,ut.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+pt,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,ut.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+pt,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,ut.__webglMultisampledFramebuffer);let nt=T.texture.mipmaps;nt&&nt.length>0?e.bindFramebuffer(i.DRAW_FRAMEBUFFER,ut.__webglFramebuffer[0]):e.bindFramebuffer(i.DRAW_FRAMEBUFFER,ut.__webglFramebuffer);for(let pt=0;pt<_.length;pt++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(J|=i.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(J|=i.STENCIL_BUFFER_BIT)),$){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,ut.__webglColorRenderbuffer[pt]);let Ct=n.get(_[pt]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Ct,0)}i.blitFramebuffer(0,0,U,k,0,0,U,k,J,i.NEAREST),l===!0&&(ht.length=0,Bt.length=0,ht.push(i.COLOR_ATTACHMENT0+pt),T.depthBuffer&&T.storeMultisampledDepthBuffer===!1&&(ht.push(ot),Bt.push(ot),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Bt)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,ht))}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),$)for(let pt=0;pt<_.length;pt++){e.bindFramebuffer(i.FRAMEBUFFER,ut.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+pt,i.RENDERBUFFER,ut.__webglColorRenderbuffer[pt]);let Ct=n.get(_[pt]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,ut.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+pt,i.TEXTURE_2D,Ct,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,ut.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.storeMultisampledDepthBuffer===!1&&l){let _=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[_])}}}function Gt(T){return Math.min(s.maxSamples,T.samples)}function Tt(T){let _=n.get(T);return T.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&_.__useRenderToTexture!==!1}function R(T){let _=a.render.frame;h.get(T)!==_&&(h.set(T,_),T.update())}function Et(T,_){let U=T.colorSpace,k=T.format,J=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||U!==gs&&U!==Dn&&(te.getTransfer(U)===re?(k!==je||J!==Ge)&&Vt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ht("WebGLTextures: Unsupported texture color space:",U)),_}function Pt(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=q,this.resetTextureUnits=B,this.getTextureUnits=L,this.setTextureUnits=z,this.setTexture2D=tt,this.setTexture2DArray=X,this.setTexture3D=V,this.setTextureCube=W,this.rebindTextures=Q,this.setupRenderTarget=rt,this.updateRenderTargetMipmap=at,this.updateMultisampleRenderTarget=Ut,this.setupDepthRenderbuffer=et,this.setupFrameBufferTexture=St,this.useMultisampledRTT=Tt,this.isReversedDepthBuffer=function(){return e.buffers.depth.getReversed()}}function l0(i,t){function e(n,s=Dn){let r,a=te.getTransfer(s);if(n===Ge)return i.UNSIGNED_BYTE;if(n===ya)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Ma)return i.UNSIGNED_SHORT_5_5_5_1;if(n===fl)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===pl)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===ul)return i.BYTE;if(n===dl)return i.SHORT;if(n===$i)return i.UNSIGNED_SHORT;if(n===va)return i.INT;if(n===on)return i.UNSIGNED_INT;if(n===ln)return i.FLOAT;if(n===cn)return i.HALF_FLOAT;if(n===ml)return i.ALPHA;if(n===gl)return i.RGB;if(n===je)return i.RGBA;if(n===mn)return i.DEPTH_COMPONENT;if(n===ti)return i.DEPTH_STENCIL;if(n===_l)return i.RED;if(n===Sa)return i.RED_INTEGER;if(n===ei)return i.RG;if(n===ba)return i.RG_INTEGER;if(n===Ta)return i.RGBA_INTEGER;if(n===Hs||n===Ws||n===Xs||n===qs)if(a===re)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Hs)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Ws)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Xs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===qs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Hs)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Ws)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Xs)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===qs)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===wa||n===Aa||n===Ea||n===Ca)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===wa)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Aa)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Ea)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Ca)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Ra||n===Ia||n===Pa||n===La||n===Da||n===Ys||n===Na)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Ra||n===Ia)return a===re?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Pa)return a===re?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===La)return r.COMPRESSED_R11_EAC;if(n===Da)return r.COMPRESSED_SIGNED_R11_EAC;if(n===Ys)return r.COMPRESSED_RG11_EAC;if(n===Na)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Ua||n===Fa||n===Oa||n===Ba||n===za||n===Va||n===ka||n===Ga||n===Ha||n===Wa||n===Xa||n===qa||n===Ya||n===Za)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Ua)return a===re?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Fa)return a===re?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Oa)return a===re?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Ba)return a===re?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===za)return a===re?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Va)return a===re?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===ka)return a===re?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Ga)return a===re?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Ha)return a===re?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Wa)return a===re?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Xa)return a===re?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===qa)return a===re?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Ya)return a===re?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Za)return a===re?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Ja||n===$a||n===Ka)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(n===Ja)return a===re?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===$a)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Ka)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Qa||n===ja||n===Zs||n===to)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(n===Qa)return r.COMPRESSED_RED_RGTC1_EXT;if(n===ja)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Zs)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===to)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Ki?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:e}}var c0=`
void main() {
...
}`,Hl=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e){if(this.texture===null){let n=new As(t.texture);(t.depthNear!==e.depthNear||t.depthFar!==e.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=n}}getMesh(t){if(this.texture!==null&&this.mesh===null){let e=t.cameras[0].viewport,n=new Ye({vertexShader:c0,fragmentShader:h0,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new le(new Ln(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Wl=class extends gn{constructor(t,e){super();let n=this,s=null,r=1,a=null,o="local-floor",l=1,c=null,h=null,d=null,u=null,f=null,g=null,M=typeof XRWebGLBinding<"u",m=new Hl,p={},A=e.getContextAttributes(),E=null,v=null,S=[],b=[],C=new ct,x=null,w=null,I=new Ee;I.viewport=new me;let P=new Ee;P.viewport=new me;let O=[I,P],B=new pa,L=null,z=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(K){let it=S[K];return it===void 0&&(it=new Oi,S[K]=it),it.getTargetRaySpace()},this.getControllerGrip=function(K){let it=S[K];return it===void 0&&(it=new Oi,S[K]=it),it.getGripSpace()},this.getHand=function(K){let it=S[K];return it===void 0&&(it=new Oi,S[K]=it),it.getHandSpace()};function q(K){let it=b.indexOf(K.inputSource);if(it===-1)return;let xt=S[it];xt!==void 0&&(xt.update(K.inputSource,K.frame,c||a),xt.dispatchEvent({type:K.type,data:K.inputSource}))}function Y(){s.removeEventListener("select",q),s.removeEventListener("selectstart",q),s.removeEventListener("selectend",q),s.removeEventListener("squeeze",q),s.removeEventListener("squeezestart",q),s.removeEventListener("squeezeend",q),s.removeEventListener("end",Y),s.removeEventListener("inputsourceschange",tt);for(let K=0;K<S.length;K++){let it=b[K];it!==null&&(b[K]=null,S[K].disconnect(it))}L=null,z=null,m.reset();for(let K in p)delete p[K];if(t.setRenderTarget(E),f=null,u=null,d=null,s=null,v=null,jt.stop(),n.isPresenting=!1,t.setPixelRatio(x),t.setSize(C.width,C.height,!1),w!==null){let K=w.camera;K.fov=w.fov,K.zoom=w.zoom,K.updateProjectionMatrix(),w=null}n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(K){r=K,n.isPresenting===!0&&Vt("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(K){o=K,n.isPresenting===!0&&Vt("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(K){c=K},this.getBaseLayer=function(){return u!==null?u:f},this.getBinding=function(){return d===null&&M&&(d=new XRWebGLBinding(s,e)),d},this.getFrame=function(){return g},this.getSession=function(){return s},this.setSession=async function(K){if(s=K,s!==null){if(E=t.getRenderTarget(),s.addEventListener("select",q),s.addEventListener("selectstart",q),s.addEventListener("selectend",q),s.addEventListener("squeeze",q),s.addEventListener("squeezestart",q),s.addEventListener("squeezeend",q),s.addEventListener("end",Y),s.addEventListener("inputsourceschange",tt),A.xrCompatible!==!0&&await e.makeXRCompatible(),x=t.getPixelRatio(),t.getSize(C),M&&"createProjectionLayer"in XRWebGLBinding.prototype){let xt=null,zt=null,St=null;A.depth&&(St=A.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,xt=A.stencil?ti:mn,zt=A.stencil?Ki:on);let kt={colorFormat:e.RGBA8,depthFormat:St,scaleFactor:r};d=this.getBinding(),u=d.createProjectionLayer(kt),s.updateRenderState({layers:[u]}),t.setPixelRatio(1),t.setSize(u.textureWidth,u.textureHeight,!1),v=new ke(u.textureWidth,u.textureHeight,{format:je,type:Ge,depthTexture:new Wn(u.textureWidth,u.textureHeight,zt,void 0,void 0,void 0,void 0,void 0,void 0,xt),stencilBuffer:A.stencil,colorSpace:t.outputColorSpace,samples:A.antialias?4:0,resolveDepthBuffer:u.ignoreDepthValues===!1,resolveStencilBuffer:u.ignoreDepthValues===!1,storeMultisampledDepthBuffer:u.ignoreDepthValues===!1,storeMultisampledStencilBuffer:u.ignoreDepthValues===!1})}else{let xt={antialias:A.antialias,alpha:!0,depth:A.depth,stencil:A.stencil,framebufferScaleFactor:r};f=new XRWebGLLayer(s,e,xt),s.updateRenderState({baseLayer:f}),t.setPixelRatio(1),t.setSize(f.framebufferWidth,f.framebufferHeight,!1),v=new ke(f.framebufferWidth,f.framebufferHeight,{format:je,type:Ge,colorSpace:t.outputColorSpace,stencilBuffer:A.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1,storeMultisampledDepthBuffer:f.ignoreDepthValues===!1,storeMultisampledStencilBuffer:f.ignoreDepthValues===!1})}v.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await s.requestReferenceSpace(o),jt.setContext(s),jt.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function tt(K){for(let it=0;it<K.removed.length;it++){let xt=K.removed[it],zt=b.indexOf(xt);zt>=0&&(b[zt]=null,S[zt].disconnect(xt))}for(let it=0;it<K.added.length;it++){let xt=K.added[it],zt=b.indexOf(xt);if(zt===-1){for(let kt=0;kt<S.length;kt++)if(kt>=b.length){b.push(xt),zt=kt;break}else if(b[kt]===null){b[kt]=xt,zt=kt;break}if(zt===-1)break}let St=S[zt];St&&St.connect(xt)}}let X=new D,V=new D;function W(K,it,xt){X.setFromMatrixPosition(it.matrixWorld),V.setFromMatrixPosition(xt.matrixWorld);let zt=X.distanceTo(V),St=it.projectionMatrix.elements,kt=xt.projectionMatrix.elements,ne=St[14]/(St[10]-1),et=St[14]/(St[10]+1),Q=(St[9]+1)/St[5],rt=(St[9]-1)/St[5],at=(St[8]-1)/St[0],ht=(kt[8]+1)/kt[0],Bt=ne*at,Ut=ne*ht,Gt=zt/(-at+ht),Tt=Gt*-at;if(it.matrixWorld.decompose(K.position,K.quaternion,K.scale),K.translateX(Tt),K.translateZ(Gt),K.matrixWorld.compose(K.position,K.quaternion,K.scale),K.matrixWorldInverse.copy(K.matrixWorld).invert(),St[10]===-1)K.projectionMatrix.copy(it.projectionMatrix),K.projectionMatrixInverse.copy(it.projectionMatrixInverse);else{let R=ne+Gt,Et=et+Gt,Pt=Bt-Tt,T=Ut+(zt-Tt),_=Q*et/Et*R,U=rt*et/Et*R;K.projectionMatrix.makePerspective(Pt,T,_,U,R,Et),K.projectionMatrixInverse.copy(K.projectionMatrix).invert()}}function lt(K,it){it===null?K.matrixWorld.copy(K.matrix):K.matrixWorld.multiplyMatrices(it.matrixWorld,K.matrix),K.matrixWorldInverse.copy(K.matrixWorld).invert()}this.updateCamera=function(K){if(s===null)return;let it=K.near,xt=K.far;m.texture!==null&&(m.depthNear>0&&(it=m.depthNear),m.depthFar>0&&(xt=m.depthFar)),B.near=P.near=I.near=it,B.far=P.far=I.far=xt,(L!==B.near||z!==B.far)&&(s.updateRenderState({depthNear:B.near,depthFar:B.far}),L=B.near,z=B.far),B.layers.mask=K.layers.mask|6,I.layers.mask=B.layers.mask&-5,P.layers.mask=B.layers.mask&-3;let zt=K.parent,St=B.cameras;lt(B,zt);for(let kt=0;kt<St.length;kt++)lt(St[kt],zt);St.length===2?W(B,I,P):B.projectionMatrix.copy(I.projectionMatrix),w===null&&K.isPerspectiveCamera&&(w={camera:K,fov:K.fov,zoom:K.zoom}),_t(K,B,zt)};function _t(K,it,xt){xt===null?K.matrix.copy(it.matrixWorld):(K.matrix.copy(xt.matrixWorld),K.matrix.invert(),K.matrix.multiply(it.matrixWorld)),K.matrix.decompose(K.position,K.quaternion,K.scale),K.updateMatrixWorld(!0),K.projectionMatrix.copy(it.projectionMatrix),K.projectionMatrixInverse.copy(it.projectionMatrixInverse),K.isPerspectiveCamera&&(K.fov=Or*2*Math.atan(1/K.projectionMatrix.elements[5]),K.zoom=1)}this.getCamera=function(){return B},this.getFoveation=function(){if(!(u===null&&f===null))return l},this.setFoveation=function(K){l=K,u!==null&&(u.fixedFoveation=K),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=K)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(B)},this.getCameraTexture=function(K){return p[K]};let Yt=null;function Zt(K,it){if(h=it.getViewerPose(c||a),g=it,h!==null){let xt=h.views;f!==null&&(t.setRenderTargetFramebuffer(v,f.framebuffer),t.setRenderTarget(v));let zt=!1;xt.length!==B.cameras.length&&(B.cameras.length=0,zt=!0);for(let et=0;et<xt.length;et++){let Q=xt[et],rt=null;if(f!==null)rt=f.getViewport(Q);else{let ht=d.getViewSubImage(u,Q);rt=ht.viewport,et===0&&(t.setRenderTargetTextures(v,ht.colorTexture,ht.depthStencilTexture),t.setRenderTarget(v))}let at=O[et];at===void 0&&(at=new Ee,at.layers.enable(et),at.viewport=new me,O[et]=at),at.matrix.fromArray(Q.transform.matrix),at.matrix.decompose(at.position,at.quaternion,at.scale),at.projectionMatrix.fromArray(Q.projectionMatrix),at.projectionMatrixInverse.copy(at.projectionMatrix).invert(),at.viewport.set(rt.x,rt.y,rt.width,rt.height),et===0&&(B.matrix.copy(at.matrix),B.matrix.decompose(B.position,B.quaternion,B.scale)),zt===!0&&B.cameras.push(at)}let St=s.enabledFeatures;if(St&&St.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&M){d=n.getBinding();let et=d.getDepthInformation(xt[0]);et&&et.isValid&&et.texture&&m.init(et,s.renderState)}if(St&&St.includes("camera-access")&&M){t.state.unbindTexture(),d=n.getBinding();for(let et=0;et<xt.length;et++){let Q=xt[et].camera;if(Q){let rt=p[Q];rt||(rt=new As,p[Q]=rt);let at=d.getCameraImage(Q);rt.sourceTexture=at}}}}for(let xt=0;xt<S.length;xt++){let zt=b[xt],St=S[xt];zt!==null&&St!==void 0&&St.update(zt,it,c||a)}Yt&&Yt(K,it),it.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:it}),g=null}let jt=new Xh;jt.setAnimationLoop(Zt),this.setAnimationLoop=function(K){Yt=K},this.dispose=function(){}}},u0=new pe,Kh=new Wt;Kh.set(-1,0,0,0,1,0,0,0,1);function d0(i,t){function e(m,p){m.matrixAutoUpdate===!0&&m.updateMatrix(),p.value.copy(m.matrix)}function n(m,p){p.color.getRGB(m.fogColor.value,Ml(i)),p.isFog?(m.fogNear.value=p.near,m.fogFar.value=p.far):p.isFogExp2&&(m.fogDensity.value=p.density)}function s(m,p,A,E,v){p.isNodeMaterial?p.uniformsNeedUpdate=!1:p.isMeshBasicMaterial?r(m,p):p.isMeshLambertMaterial?(r(m,p),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)):p.isMeshToonMaterial?(r(m,p),d(m,p)):p.isMeshPhongMaterial?(r(m,p),h(m,p),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)):p.isMeshStandardMaterial?(r(m,p),u(m,p),p.isMeshPhysicalMaterial&&f(m,p,v)):p.isMeshMatcapMaterial?(r(m,p),g(m,p)):p.isMeshDepthMaterial?r(m,p):p.isMeshDistanceMaterial?(r(m,p),M(m,p)):p.isMeshNormalMaterial?r(m,p):p.isLineBasicMaterial?(a(m,p),p.isLineDashedMaterial&&o(m,p)):p.isPointsMaterial?l(m,p,A,E):p.isSpriteMaterial?c(m,p):p.isShadowMaterial?(m.color.value.copy(p.color),m.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function r(m,p){m.opacity.value=p.opacity,p.color&&m.diffuse.value.copy(p.color),p.emissive&&m.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(m.map.value=p.map,e(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.bumpMap&&(m.bumpMap.value=p.bumpMap,e(p.bumpMap,m.bumpMapTransform),m.bumpScale.value=p.bumpScale,p.side===ze&&(m.bumpScale.value*=-1)),p.normalMap&&(m.normalMap.value=p.normalMap,e(p.normalMap,m.normalMapTransform),m.normalScale.value.copy(p.normalScale),p.side===ze&&m.normalScale.value.negate()),p.displacementMap&&(m.displacementMap.value=p.displacementMap,e(p.displacementMap,m.displacementMapTransform),m.displacementScale.value=p.displacementScale,m.displacementBias.value=p.displacementBias),p.emissiveMap&&(m.emissiveMap.value=p.emissiveMap,e(p.emissiveMap,m.emissiveMapTransform)),p.specularMap&&(m.specularMap.value=p.specularMap,e(p.specularMap,m.specularMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest);let A=t.get(p),E=A.envMap,v=A.envMapRotation;E&&(m.envMap.value=E,m.envMapRotation.value.setFromMatrix4(u0.makeRotationFromEuler(v)).transpose(),E.isCubeTexture&&E.isRenderTargetTexture===!1&&m.envMapRotation.value.premultiply(Kh),m.reflectivity.value=p.reflectivity,m.ior.value=p.ior,m.refractionRatio.value=p.refractionRatio),p.lightMap&&(m.lightMap.value=p.lightMap,m.lightMapIntensity.value=p.lightMapIntensity,e(p.lightMap,m.lightMapTransform)),p.aoMap&&(m.aoMap.value=p.aoMap,m.aoMapIntensity.value=p.aoMapIntensity,e(p.aoMap,m.aoMapTransform))}function a(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,p.map&&(m.map.value=p.map,e(p.map,m.mapTransform))}function o(m,p){m.dashSize.value=p.dashSize,m.totalSize.value=p.dashSize+p.gapSize,m.scale.value=p.scale}function l(m,p,A,E){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.size.value=p.size*A,m.scale.value=E*.5,p.map&&(m.map.value=p.map,e(p.map,m.uvTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function c(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.rotation.value=p.rotation,p.map&&(m.map.value=p.map,e(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function h(m,p){m.specular.value.copy(p.specular),m.shininess.value=Math.max(p.shininess,1e-4)}function d(m,p){p.gradientMap&&(m.gradientMap.value=p.gradientMap)}function u(m,p){m.metalness.value=p.metalness,p.metalnessMap&&(m.metalnessMap.value=p.metalnessMap,e(p.metalnessMap,m.metalnessMapTransform)),m.roughness.value=p.roughness,p.roughnessMap&&(m.roughnessMap.value=p.roughnessMap,e(p.roughnessMap,m.roughnessMapTransform)),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)}function f(m,p,A){m.ior.value=p.ior,p.sheen>0&&(m.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),m.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(m.sheenColorMap.value=p.sheenColorMap,e(p.sheenColorMap,m.sheenColorMapTransform)),p.sheenRoughnessMap&&(m.sheenRoughnessMap.value=p.sheenRoughnessMap,e(p.sheenRoughnessMap,m.sheenRoughnessMapTransform))),p.clearcoat>0&&(m.clearcoat.value=p.clearcoat,m.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(m.clearcoatMap.value=p.clearcoatMap,e(p.clearcoatMap,m.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,e(p.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(m.clearcoatNormalMap.value=p.clearcoatNormalMap,e(p.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===ze&&m.clearcoatNormalScale.value.negate())),p.dispersion>0&&(m.dispersion.value=p.dispersion),p.retroreflectivity>0&&(m.retroreflectivity.value=p.retroreflectivity),p.iridescence>0&&(m.iridescence.value=p.iridescence,m.iridescenceIOR.value=p.iridescenceIOR,m.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(m.iridescenceMap.value=p.iridescenceMap,e(p.iridescenceMap,m.iridescenceMapTransform)),p.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=p.iridescenceThicknessMap,e(p.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),p.transmission>0&&(m.transmission.value=p.transmission,m.transmissionSamplerMap.value=A.texture,m.transmissionSamplerSize.value.set(A.width,A.height),p.transmissionMap&&(m.transmissionMap.value=p.transmissionMap,e(p.transmissionMap,m.transmissionMapTransform)),m.thickness.value=p.thickness,p.thicknessMap&&(m.thicknessMap.value=p.thicknessMap,e(p.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=p.attenuationDistance,m.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(m.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(m.anisotropyMap.value=p.anisotropyMap,e(p.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=p.specularIntensity,m.specularColor.value.copy(p.specularColor),p.specularColorMap&&(m.specularColorMap.value=p.specularColorMap,e(p.specularColorMap,m.specularColorMapTransform)),p.specularIntensityMap&&(m.specularIntensityMap.value=p.specularIntensityMap,e(p.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,p){p.matcap&&(m.matcap.value=p.matcap)}function M(m,p){let A=t.get(p).light;m.referencePosition.value.setFromMatrixPosition(A.matrixWorld),m.nearDistance.value=A.shadow.camera.near,m.farDistance.value=A.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function f0(i,t,e,n){let s={},r={},a=[],o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(v,S){let b=S.program;n.uniformBlockBinding(v,b)}function c(v,S){let b=s[v.id];b===void 0&&(m(v),b=h(v),s[v.id]=b,v.addEventListener("dispose",A));let C=S.program;n.updateUBOMapping(v,C);let x=t.render.frame;r[v.id]!==x&&(u(v),r[v.id]=x)}function h(v){let S=d();v.__bindingPointIndex=S;let b=i.createBuffer(),C=v.__size,x=v.usage;return i.bindBuffer(i.UNIFORM_BUFFER,b),i.bufferData(i.UNIFORM_BUFFER,C,x),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,S,b),b}function d(){for(let v=0;v<o;v++)if(a.indexOf(v)===-1)return a.push(v),v;return Ht("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function u(v){let S=s[v.id],b=v.uniforms,C=v.__cache;i.bindBuffer(i.UNIFORM_BUFFER,S);for(let x=0,w=b.length;x<w;x++){let I=b[x];if(Array.isArray(I))for(let P=0,O=I.length;P<O;P++)f(I[P],x,P,C);else f(I,x,0,C)}i.bindBuffer(i.UNIFORM_BUFFER,null)}function f(v,S,b,C){if(M(v,S,b,C)===!0){let x=v.__offset,w=v.value;if(Array.isArray(w)){let I=0;for(let P=0;P<w.length;P++){let O=w[P],B=p(O);g(O,v.__data,I),typeof O!="number"&&typeof O!="boolean"&&!O.isMatrix3&&!ArrayBuffer.isView(O)&&(I+=B.storage/Float32Array.BYTES_PER_ELEMENT)}}else g(w,v.__data,0);i.bufferSubData(i.UNIFORM_BUFFER,x,v.__data)}}function g(v,S,b){typeof v=="number"||typeof v=="boolean"?S[0]=v:v.isMatrix3?(S[0]=v.elements[0],S[1]=v.elements[1],S[2]=v.elements[2],S[3]=0,S[4]=v.elements[3],S[5]=v.elements[4],S[6]=v.elements[5],S[7]=0,S[8]=v.elements[6],S[9]=v.elements[7],S[10]=v.elements[8],S[11]=0):ArrayBuffer.isView(v)?S.set(new v.constructor(v.buffer,v.byteOffset,S.length)):v.toArray(S,b)}function M(v,S,b,C){let x=v.value,w=S+"_"+b;if(C[w]===void 0)return typeof x=="number"||typeof x=="boolean"?C[w]=x:ArrayBuffer.isView(x)?C[w]=x.slice():C[w]=x.clone(),!0;{let I=C[w];if(typeof x=="number"||typeof x=="boolean"){if(I!==x)return C[w]=x,!0}else{if(ArrayBuffer.isView(x))return!0;if(I.equals(x)===!1)return I.copy(x),!0}}return!1}function m(v){let S=v.uniforms,b=0,C=16;for(let w=0,I=S.length;w<I;w++){let P=Array.isArray(S[w])?S[w]:[S[w]];for(let O=0,B=P.length;O<B;O++){let L=P[O],z=Array.isArray(L.value)?L.value:[L.value];for(let q=0,Y=z.length;q<Y;q++){let tt=z[q],X=p(tt),V=b%C,W=V%X.boundary,lt=V+W;b+=W,lt!==0&&C-lt<X.storage&&(b+=C-lt),L.__data=new Float32Array(X.storage/Float32Array.BYTES_PER_ELEMENT),L.__offset=b,b+=X.storage}}}let x=b%C;return x>0&&(b+=C-x),v.__size=b,v.__cache={},this}function p(v){let S={boundary:0,storage:0};return typeof v=="number"||typeof v=="boolean"?(S.boundary=4,S.storage=4):v.isVector2?(S.boundary=8,S.storage=8):v.isVector3||v.isColor?(S.boundary=16,S.storage=12):v.isVector4?(S.boundary=16,S.storage=16):v.isMatrix3?(S.boundary=48,S.storage=48):v.isMatrix4?(S.boundary=64,S.storage=64):v.isTexture?Vt("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(v)?(S.boundary=16,S.storage=v.byteLength):Vt("WebGLRenderer: Unsupported uniform value type.",v),S}function A(v){let S=v.target;S.removeEventListener("dispose",A);let b=a.indexOf(S.__bindingPointIndex);a.splice(b,1),i.deleteBuffer(s[S.id]),delete s[S.id],delete r[S.id]}function E(){for(let v in s)i.deleteBuffer(s[v]);a=[],s={},r={}}return{bind:l,update:c,dispose:E}}var p0=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),yn=null;function m0(){return yn===null&&(yn=new kr(p0,16,16,ei,cn),yn.name="DFG_LUT",yn.minFilter=Ce,yn.magFilter=Ce,yn.wrapS=pn,yn.wrapT=pn,yn.generateMipmaps=!1,yn.needsUpdate=!0),yn}var Qs=class{constructor(t={}){let{canvas:e=dh(),context:n=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:d=!1,reversedDepthBuffer:u=!1,outputBufferType:f=Ge}=t;this.isWebGLRenderer=!0;let g;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");g=n.getContextAttributes().alpha}else g=a;let M=f,m=new Set([Ta,ba,Sa]),p=new Set([Ge,on,$i,Ki,ya,Ma]),A=new Uint32Array(4),E=new Int32Array(4),v=new D,S=null,b=null,C=[],x=[],w=null;this.domElement=e,this.debug={checkShaderErrors:!0,diagnostics:{keywords:!1},onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=an,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let I=this,P=!1,O=null,B=null,L=null,z=null;this._outputColorSpace=De;let q=0,Y=0,tt=null,X=-1,V=null,W=new me,lt=new me,_t=null,Yt=new qt(0),Zt=0,jt=e.width,K=e.height,it=1,xt=null,zt=null,St=new me(0,0,jt,K),kt=new me(0,0,jt,K),ne=!1,et=new Bi,Q=!1,rt=!1,at=new pe,ht=new D,Bt=new me,Ut={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Gt=!1;function Tt(){return tt===null?it:1}let R=n;function Et(y,N){return e.getContext(y,N)}let Pt,T,_,U,k,J,ot,ut,$,nt,pt,Ct,ft,mt,Dt,Ft,Xt,F,dt,j,gt,bt,st;try{let y={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:d};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${"186"}`),e.addEventListener("webglcontextlost",he,!1),e.addEventListener("webglcontextrestored",ie,!1),e.addEventListener("webglcontextcreationerror",tn,!1),R===null){let N="webgl2";if(R=Et(N,y),R===null)throw Et(N)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}Ot()}catch(y){throw e.removeEventListener("webglcontextlost",he,!1),e.removeEventListener("webglcontextrestored",ie,!1),e.removeEventListener("webglcontextcreationerror",tn,!1),Ht("WebGLRenderer: "+y.message),y}function Ot(){Pt=new Sm(R),Pt.init(),gt=new l0(R,Pt),T=new dm(R,Pt,t,gt),_=new a0(R,Pt),T.reversedDepthBuffer&&u&&_.buffers.depth.setReversed(!0),B=R.createFramebuffer(),L=R.createFramebuffer(),z=R.createFramebuffer(),U=new wm(R),k=new qg,J=new o0(R,Pt,_,k,T,gt,U),ot=new Mm(I),ut=new Ad(R),bt=new hm(R,ut),$=new bm(R,ut,U,bt),nt=new Em(R,$,ut,bt,U),F=new Am(R,T,J),Dt=new fm(k),pt=new Xg(I,ot,Pt,T,bt,Dt),Ct=new d0(I,k),ft=new Zg,mt=new t0(Pt),Xt=new cm(I,ot,_,nt,g,l),Ft=new r0(I,nt,T),st=new f0(R,U,T,_),dt=new um(R,Pt,U),j=new Tm(R,Pt,U),U.programs=pt.programs,I.capabilities=T,I.extensions=Pt,I.properties=k,I.renderLists=ft,I.shadowMap=Ft,I.state=_,I.info=U}M!==Ge&&(w=new Rm(M,e.width,e.height,o,s,r));let Lt=new Wl(I,R);this.xr=Lt,this.getContext=function(){return R},this.getContextAttributes=function(){return R.getContextAttributes()},this.forceContextLoss=function(){let y=Pt.get("WEBGL_lose_context");y&&y.loseContext()},this.forceContextRestore=function(){let y=Pt.get("WEBGL_lose_context");y&&y.restoreContext()},this.getPixelRatio=function(){return it},this.setPixelRatio=function(y){y!==void 0&&(it=y,this.setSize(jt,K,!1))},this.getSize=function(y){return y.set(jt,K)},this.setSize=function(y,N,Z=!0){if(Lt.isPresenting){Vt("WebGLRenderer: Can't change size while VR device is presenting.");return}jt=y,K=N,e.width=Math.floor(y*it),e.height=Math.floor(N*it),Z===!0&&(e.style.width=y+"px",e.style.height=N+"px"),w!==null&&w.setSize(e.width,e.height),this.setViewport(0,0,y,N)},this.getDrawingBufferSize=function(y){return y.set(jt*it,K*it).floor()},this.setDrawingBufferSize=function(y,N,Z){jt=y,K=N,it=Z,e.width=Math.floor(y*Z),e.height=Math.floor(N*Z),this.setViewport(0,0,y,N)},this.setEffects=function(y){if(M===Ge){Ht("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(y){for(let N=0;N<y.length;N++)if(y[N].isOutputPass===!0){Vt("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}w.setEffects(y||[])},this.getCurrentViewport=function(y){return y.copy(W)},this.getViewport=function(y){return y.copy(St)},this.setViewport=function(y,N,Z,G){y.isVector4?St.set(y.x,y.y,y.z,y.w):St.set(y,N,Z,G),_.viewport(W.copy(St).multiplyScalar(it).round())},this.getScissor=function(y){return y.copy(kt)},this.setScissor=function(y,N,Z,G){y.isVector4?kt.set(y.x,y.y,y.z,y.w):kt.set(y,N,Z,G),_.scissor(lt.copy(kt).multiplyScalar(it).round())},this.getScissorTest=function(){return ne},this.setScissorTest=function(y){_.setScissorTest(ne=y)},this.setOpaqueSort=function(y){xt=y},this.setTransparentSort=function(y){zt=y},this.getClearColor=function(y){return y.copy(Xt.getClearColor())},this.setClearColor=function(){Xt.setClearColor(...arguments)},this.getClearAlpha=function(){return Xt.getClearAlpha()},this.setClearAlpha=function(){Xt.setClearAlpha(...arguments)},this.clear=function(y=!0,N=!0,Z=!0){let G=0;if(y){let H=!1;if(tt!==null){let Mt=tt.texture.format;H=m.has(Mt)}if(H){let Mt=tt.texture.type,At=p.has(Mt),yt=Xt.getClearColor(),Rt=Xt.getClearAlpha(),Nt=yt.r,Jt=yt.g,Qt=yt.b;At?(A[0]=Nt,A[1]=Jt,A[2]=Qt,A[3]=Rt,R.clearBufferuiv(R.COLOR,0,A)):(E[0]=Nt,E[1]=Jt,E[2]=Qt,E[3]=Rt,R.clearBufferiv(R.COLOR,0,E))}else G|=R.COLOR_BUFFER_BIT}N&&(G|=R.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),Z&&(G|=R.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),G!==0&&R.clear(G)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(y){y.setRenderer(this),O=y},this.dispose=function(){e.removeEventListener("webglcontextlost",he,!1),e.removeEventListener("webglcontextrestored",ie,!1),e.removeEventListener("webglcontextcreationerror",tn,!1),Xt.dispose(),ft.dispose(),mt.dispose(),k.dispose(),ot.dispose(),nt.dispose(),bt.dispose(),st.dispose(),pt.dispose(),Lt.dispose(),Lt.removeEventListener("sessionstart",ql),Lt.removeEventListener("sessionend",Yl),ni.stop()};function he(y){y.preventDefault(),vl("WebGLRenderer: Context Lost."),P=!0}function ie(){vl("WebGLRenderer: Context Restored."),P=!1;let y=U.autoReset,N=Ft.enabled,Z=Ft.autoUpdate,G=Ft.needsUpdate,H=Ft.type;Ot(),U.autoReset=y,Ft.enabled=N,Ft.autoUpdate=Z,Ft.needsUpdate=G,Ft.type=H}function tn(y){Ht("WebGLRenderer: A WebGL context could not be created. Reason: ",y.statusMessage)}function un(y){let N=y.target;N.removeEventListener("dispose",un),ru(N)}function ru(y){au(y),k.remove(y)}function au(y){let N=k.get(y).programs;N!==void 0&&(N.forEach(function(Z){pt.releaseProgram(Z)}),y.isShaderMaterial&&pt.releaseShaderCache(y))}this.renderBufferDirect=function(y,N,Z,G,H,Mt){N===null&&(N=Ut);let At=H.isMesh&&H.matrixWorld.determinantAffine()<0,yt=cu(y,N,Z,G,H);_.setMaterial(G,At);let Rt=Z.index,Nt=1;if(G.wireframe===!0){if(Rt=$.getWireframeAttribute(Z),Rt===void 0)return;Nt=2}let Jt=Z.drawRange,Qt=Z.attributes.position,It=Jt.start*Nt,se=(Jt.start+Jt.count)*Nt;Mt!==null&&(It=Math.max(It,Mt.start*Nt),se=Math.min(se,(Mt.start+Mt.count)*Nt)),Rt!==null?(It=Math.max(It,0),se=Math.min(se,Rt.count)):Qt!=null&&(It=Math.max(It,0),se=Math.min(se,Qt.count));let ve=se-It;if(ve<0||ve===1/0)return;bt.setup(H,G,yt,Z,Rt);let de,ce=dt;if(Rt!==null&&(de=ut.get(Rt),ce=j,ce.setIndex(de)),H.isMesh)G.wireframe===!0?(_.setLineWidth(G.wireframeLinewidth*Tt()),ce.setMode(R.LINES)):ce.setMode(R.TRIANGLES);else if(H.isLine){let Ie=G.linewidth;Ie===void 0&&(Ie=1),_.setLineWidth(Ie*Tt()),H.isLineSegments?ce.setMode(R.LINES):H.isLineLoop?ce.setMode(R.LINE_LOOP):ce.setMode(R.LINE_STRIP)}else H.isPoints?ce.setMode(R.POINTS):H.isSprite&&ce.setMode(R.TRIANGLES);if(H.isBatchedMesh)if(Pt.get("WEBGL_multi_draw"))ce.renderMultiDraw(H._multiDrawStarts,H._multiDrawCounts,H._multiDrawCount);else{let Ie=H._multiDrawStarts,wt=H._multiDrawCounts,Fe=H._multiDrawCount,ee=Rt?ut.get(Rt).bytesPerElement:1,$e=k.get(G).currentProgram.getUniforms();for(let dn=0;dn<Fe;dn++)$e.setValue(R,"_gl_DrawID",dn),ce.render(Ie[dn]/ee,wt[dn])}else if(H.isInstancedMesh)ce.renderInstances(It,ve,H.count);else if(Z.isInstancedBufferGeometry){let Ie=Z._maxInstanceCount!==void 0?Z._maxInstanceCount:1/0,wt=Math.min(Z.instanceCount,Ie);ce.renderInstances(It,ve,wt)}else ce.render(It,ve)};function Xl(y,N,Z,G){O!==null&&y.isNodeMaterial&&O.setObject(G,y),Q===!0&&Dt.setState(y,Z,!1),y.transparent===!0&&y.side===Je&&y.forceSinglePass===!1?(y.side=ze,y.needsUpdate=!0,nr(y,N,G),y.side=Kn,y.needsUpdate=!0,nr(y,N,G),y.side=Je):nr(y,N,G)}this.compile=function(y,N,Z=null){Z===null&&(Z=y),O!==null&&O.renderStart(y,N,Z),b=mt.get(Z),b.init(N),x.push(b),Z.traverseVisible(function(H){H.isLight&&H.layers.test(N.layers)&&(b.pushLight(H),H.castShadow&&b.pushShadow(H))}),y!==Z&&y.traverseVisible(function(H){H.isLight&&H.layers.test(N.layers)&&(b.pushLight(H),H.castShadow&&b.pushShadow(H))}),b.setupLights(),O!==null&&O.updateLights(b.state.lightsArray),rt=this.localClippingEnabled,Q=Dt.init(this.clippingPlanes,rt),Q===!0&&Dt.setGlobalState(this.clippingPlanes,N),O!==null&&Ft.render(b.state.shadowsArray,Z,N);let G=new Set;return y.traverse(function(H){if(!(H.isMesh||H.isPoints||H.isLine||H.isSprite))return;let Mt=H.material;if(Mt)if(Array.isArray(Mt))for(let At=0;At<Mt.length;At++){let yt=Mt[At];Xl(yt,Z,N,H),G.add(yt)}else Xl(Mt,Z,N,H),G.add(Mt)}),b=x.pop(),O!==null&&O.renderEnd(),G},this.compileAsync=function(y,N,Z=null){let G=this.compile(y,N,Z);return new Promise(H=>{function Mt(){if(G.forEach(function(At){let Rt=k.get(At).currentProgram;(Rt===void 0||Rt.isReady())&&G.delete(At)}),G.size===0){H(y);return}setTimeout(Mt,10)}Pt.get("KHR_parallel_shader_compile")!==null?Mt():setTimeout(Mt,10)})};let uo=null;function ou(y){uo&&uo(y)}function ql(){ni.stop()}function Yl(){ni.start()}let ni=new Xh;ni.setAnimationLoop(ou),typeof self<"u"&&ni.setContext(self),this.setAnimationLoop=function(y){uo=y,Lt.setAnimationLoop(y),y===null?ni.stop():ni.start()},Lt.addEventListener("sessionstart",ql),Lt.addEventListener("sessionend",Yl),this.render=function(y,N){if(N!==void 0&&N.isCamera!==!0){Ht("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(P===!0)return;O!==null&&O.renderStart(y,N);let Z=Lt.enabled===!0&&Lt.isPresenting===!0,G=w!==null&&(tt===null||Z)&&w.begin(I,tt);if(y.matrixWorldAutoUpdate===!0&&y.updateMatrixWorld(),N.parent===null&&N.matrixWorldAutoUpdate===!0&&N.updateMatrixWorld(),Lt.enabled===!0&&Lt.isPresenting===!0&&(w===null||w.isCompositing()===!1)&&(Lt.cameraAutoUpdate===!0&&Lt.updateCamera(N),N=Lt.getCamera()),y.isScene===!0&&y.onBeforeRender(I,y,N,tt),b=mt.get(y,x.length),b.init(N),b.state.textureUnits=J.getTextureUnits(),x.push(b),at.multiplyMatrices(N.projectionMatrix,N.matrixWorldInverse),et.setFromProjectionMatrix(at,rn,N.reversedDepth),rt=this.localClippingEnabled,Q=Dt.init(this.clippingPlanes,rt),S=ft.get(y,C.length),S.init(),C.push(S),Lt.enabled===!0&&Lt.isPresenting===!0){let At=I.xr.getDepthSensingMesh();At!==null&&fo(At,N,-1/0,I.sortObjects)}fo(y,N,0,I.sortObjects),S.finish(),O!==null&&O.updateLights(b.state.lightsArray),I.sortObjects===!0&&S.sort(xt,zt),Gt=Lt.enabled===!1||Lt.isPresenting===!1||Lt.hasDepthSensing()===!1,Gt&&Xt.addToRenderList(S,y),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Q===!0&&Dt.beginShadows();let H=b.state.shadowsArray;if(Ft.render(H,y,N),Q===!0&&Dt.endShadows(),(G&&w.hasRenderPass())===!1){let At=S.opaque,yt=S.transmissive;if(b.setupLights(),N.isArrayCamera){let Rt=N.cameras;if(yt.length>0)for(let Nt=0,Jt=Rt.length;Nt<Jt;Nt++){let Qt=Rt[Nt];Jl(At,yt,y,Qt)}Gt&&Xt.render(y);for(let Nt=0,Jt=Rt.length;Nt<Jt;Nt++){let Qt=Rt[Nt];Zl(S,y,Qt,Qt.viewport)}}else yt.length>0&&Jl(At,yt,y,N),Gt&&Xt.render(y),Zl(S,y,N)}tt!==null&&Y===0&&(J.updateMultisampleRenderTarget(tt),J.updateRenderTargetMipmap(tt)),G&&w.end(I),y.isScene===!0&&y.onAfterRender(I,y,N),bt.resetDefaultState(),X=-1,V=null,x.pop(),x.length>0?(b=x[x.length-1],J.setTextureUnits(b.state.textureUnits),Q===!0&&Dt.setGlobalState(I.clippingPlanes,b.state.camera)):b=null,C.pop(),C.length>0?S=C[C.length-1]:S=null,O!==null&&O.renderEnd()};function fo(y,N,Z,G){if(y.visible===!1)return;if(y.layers.test(N.layers)){if(y.isGroup)Z=y.renderOrder;else if(y.isLOD)y.autoUpdate===!0&&y.update(N);else if(y.isLightProbeGrid)b.pushLightProbeGrid(y);else if(y.isLight)b.pushLight(y),y.castShadow&&b.pushShadow(y);else if(y.isSprite){if(!y.frustumCulled||y.intersectsFrustum(et)){G&&Bt.setFromMatrixPosition(y.matrixWorld).applyMatrix4(at);let At=nt.update(y),yt=y.material;yt.visible&&S.push(y,At,yt,Z,Bt.z,null,N)}}else if((y.isMesh||y.isLine||y.isPoints)&&(!y.frustumCulled||y.intersectsFrustum(et))){let At=nt.update(y),yt=y.material;if(G&&(y.boundingSphere!==void 0?(y.boundingSphere===null&&y.computeBoundingSphere(),Bt.copy(y.boundingSphere.center)):(At.boundingSphere===null&&At.computeBoundingSphere(),Bt.copy(At.boundingSphere.center)),Bt.applyMatrix4(y.matrixWorld).applyMatrix4(at)),Array.isArray(yt)){let Rt=At.groups;for(let Nt=0,Jt=Rt.length;Nt<Jt;Nt++){let Qt=Rt[Nt],It=yt[Qt.materialIndex];It&&It.visible&&S.push(y,At,It,Z,Bt.z,Qt,N)}}else yt.visible&&S.push(y,At,yt,Z,Bt.z,null,N)}}let Mt=y.children;for(let At=0,yt=Mt.length;At<yt;At++)fo(Mt[At],N,Z,G)}function Zl(y,N,Z,G){let{opaque:H,transmissive:Mt,transparent:At}=y;b.setupLightsView(Z),Q===!0&&Dt.setGlobalState(I.clippingPlanes,Z),G&&_.viewport(W.copy(G)),H.length>0&&er(H,N,Z),Mt.length>0&&er(Mt,N,Z),At.length>0&&er(At,N,Z),_.buffers.depth.setTest(!0),_.buffers.depth.setMask(!0),_.buffers.color.setMask(!0),_.setPolygonOffset(!1)}function Jl(y,N,Z,G){if((Z.isScene===!0?Z.overrideMaterial:null)!==null)return;if(b.state.transmissionRenderTarget[G.id]===void 0){let It=Pt.has("EXT_color_buffer_half_float")||Pt.has("EXT_color_buffer_float");b.state.transmissionRenderTarget[G.id]=new ke(1,1,{generateMipmaps:!0,type:It?cn:Ge,minFilter:jn,samples:Math.max(4,T.samples),stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,storeMultisampledDepthBuffer:!1,storeMultisampledStencilBuffer:!1,colorSpace:te.workingColorSpace})}let Mt=b.state.transmissionRenderTarget[G.id],At=G.viewport||W;Mt.setSize(At.z*I.transmissionResolutionScale,At.w*I.transmissionResolutionScale);let yt=I.getRenderTarget(),Rt=I.getActiveCubeFace(),Nt=I.getActiveMipmapLevel();I.setRenderTarget(Mt),I.getClearColor(Yt),Zt=I.getClearAlpha(),Zt<1&&I.setClearColor(16777215,.5),I.clear(),Gt&&Xt.render(Z);let Jt=I.toneMapping;I.toneMapping=an;let Qt=G.viewport;if(G.viewport!==void 0&&(G.viewport=void 0),b.setupLightsView(G),Q===!0&&Dt.setGlobalState(I.clippingPlanes,G),er(y,Z,G),J.updateMultisampleRenderTarget(Mt),J.updateRenderTargetMipmap(Mt),Pt.has("WEBGL_multisampled_render_to_texture")===!1){let It=!1;for(let se=0,ve=N.length;se<ve;se++){let de=N[se],{object:ce,geometry:Ie,material:wt,group:Fe}=de;if(wt.side===Je&&ce.layers.test(G.layers)){let ee=wt.side;wt.side=ze,wt.needsUpdate=!0,$l(ce,Z,G,Ie,wt,Fe),wt.side=ee,wt.needsUpdate=!0,It=!0}}It===!0&&(J.updateMultisampleRenderTarget(Mt),J.updateRenderTargetMipmap(Mt))}I.setRenderTarget(yt,Rt,Nt),I.setClearColor(Yt,Zt),Qt!==void 0&&(G.viewport=Qt),I.toneMapping=Jt}function er(y,N,Z){let G=N.isScene===!0?N.overrideMaterial:null;for(let H=0,Mt=y.length;H<Mt;H++){let At=y[H],{object:yt,geometry:Rt,group:Nt}=At,Jt=At.material;Jt.allowOverride===!0&&G!==null&&(Jt=G),yt.layers.test(Z.layers)&&$l(yt,N,Z,Rt,Jt,Nt)}}function $l(y,N,Z,G,H,Mt){O!==null&&H.isNodeMaterial&&O.setObject(y,H),y.onBeforeRender(I,N,Z,G,H,Mt),y.modelViewMatrix.multiplyMatrices(Z.matrixWorldInverse,y.matrixWorld),y.normalMatrix.getNormalMatrix(y.modelViewMatrix),H.onBeforeRender(I,N,Z,G,y,Mt),H.transparent===!0&&H.side===Je&&H.forceSinglePass===!1?(H.side=ze,H.needsUpdate=!0,I.renderBufferDirect(Z,N,G,H,y,Mt),H.side=Kn,H.needsUpdate=!0,I.renderBufferDirect(Z,N,G,H,y,Mt),H.side=Je):I.renderBufferDirect(Z,N,G,H,y,Mt),y.onAfterRender(I,N,Z,G,H,Mt)}function nr(y,N,Z){N.isScene!==!0&&(N=Ut);let G=k.get(y),H=b.state.lights,Mt=b.state.shadowsArray,At=H.state.version,yt=pt.getParameters(y,H.state,Mt,N,Z,b.state.lightProbeGridArray),Rt=pt.getProgramCacheKey(yt),Nt=G.programs;G.environment=y.isMeshStandardMaterial||y.isMeshLambertMaterial||y.isMeshPhongMaterial?N.environment:null,G.fog=N.fog;let Jt=y.isMeshStandardMaterial||y.isMeshLambertMaterial&&!y.envMap||y.isMeshPhongMaterial&&!y.envMap;G.envMap=ot.get(y.envMap||G.environment,Jt),G.envMapRotation=G.environment!==null&&y.envMap===null?N.environmentRotation:y.envMapRotation,Nt===void 0&&(y.addEventListener("dispose",un),Nt=new Map,G.programs=Nt);let Qt=Nt.get(Rt);if(Qt!==void 0){if(G.currentProgram===Qt&&G.lightsStateVersion===At)return Ql(y,yt),Qt}else yt.uniforms=pt.getUniforms(y),O!==null&&y.isNodeMaterial&&O.build(y,Z,yt),y.onBeforeCompile(yt,I),Qt=pt.acquireProgram(yt,Rt),Nt.set(Rt,Qt),G.uniforms=yt.uniforms;let It=G.uniforms;return(!y.isShaderMaterial&&!y.isRawShaderMaterial||y.clipping===!0)&&(It.clippingPlanes=Dt.uniform),Ql(y,yt),G.needsLights=uu(y),G.lightsStateVersion=At,G.needsLights&&(It.ambientLightColor.value=H.state.ambient,It.lightProbe.value=H.state.probe,It.sunLights.value=H.state.sun,It.sunLightShadows.value=H.state.sunShadow,It.directionalLights.value=H.state.directional,It.directionalLightShadows.value=H.state.directionalShadow,It.spotLights.value=H.state.spot,It.spotLightShadows.value=H.state.spotShadow,It.rectAreaLights.value=H.state.rectArea,It.ltc_1.value=H.state.rectAreaLTC1,It.ltc_2.value=H.state.rectAreaLTC2,It.pointLights.value=H.state.point,It.pointLightShadows.value=H.state.pointShadow,It.hemisphereLights.value=H.state.hemi,It.sunShadowMatrix.value=H.state.sunShadowMatrix,It.sunShadowCascade.value=H.state.sunShadowCascade,It.directionalShadowMatrix.value=H.state.directionalShadowMatrix,It.spotLightMatrix.value=H.state.spotLightMatrix,It.spotLightMap.value=H.state.spotLightMap,It.pointShadowMatrix.value=H.state.pointShadowMatrix),G.lightProbeGrid=b.state.lightProbeGridArray.length>0,G.currentProgram=Qt,G.uniformsList=null,Qt}function Kl(y){if(y.uniformsList===null){let N=y.currentProgram.getUniforms();y.uniformsList=es.seqWithValue(N.seq,y.uniforms)}return y.uniformsList}function Ql(y,N){let Z=k.get(y);Z.outputColorSpace=N.outputColorSpace,Z.batching=N.batching,Z.batchingColor=N.batchingColor,Z.instancing=N.instancing,Z.instancingColor=N.instancingColor,Z.instancingMorph=N.instancingMorph,Z.skinning=N.skinning,Z.morphTargets=N.morphTargets,Z.morphNormals=N.morphNormals,Z.morphColors=N.morphColors,Z.morphTargetsCount=N.morphTargetsCount,Z.numClippingPlanes=N.numClippingPlanes,Z.numIntersection=N.numClipIntersection,Z.vertexAlphas=N.vertexAlphas,Z.vertexTangents=N.vertexTangents,Z.toneMapping=N.toneMapping}function lu(y,N){if(y.length===0)return null;if(y.length===1)return y[0].texture!==null?y[0]:null;v.setFromMatrixPosition(N.matrixWorld);for(let Z=0,G=y.length;Z<G;Z++){let H=y[Z];if(H.texture!==null&&H.boundingBox.containsPoint(v))return H}return null}function cu(y,N,Z,G,H){N.isScene!==!0&&(N=Ut),J.resetTextureUnits();let Mt=N.fog,At=G.isMeshStandardMaterial||G.isMeshLambertMaterial||G.isMeshPhongMaterial?N.environment:null,yt=tt===null?I.outputColorSpace:tt.isXRRenderTarget===!0?tt.texture.colorSpace:te.workingColorSpace,Rt=G.isMeshStandardMaterial||G.isMeshLambertMaterial&&!G.envMap||G.isMeshPhongMaterial&&!G.envMap,Nt=ot.get(G.envMap||At,Rt),Jt=G.vertexColors===!0&&!!Z.attributes.color&&Z.attributes.color.itemSize===4,Qt=!!Z.attributes.tangent&&(!!G.normalMap||G.anisotropy>0),It=!!Z.morphAttributes.position,se=!!Z.morphAttributes.normal,ve=!!Z.morphAttributes.color,de=an;G.toneMapped&&(tt===null||tt.isXRRenderTarget===!0)&&(de=I.toneMapping);let ce=Z.morphAttributes.position||Z.morphAttributes.normal||Z.morphAttributes.color,Ie=ce!==void 0?ce.length:0,wt=k.get(G),Fe=b.state.lights;if(Q===!0&&(rt===!0||y!==V)){let ue=y===V&&G.id===X;Dt.setState(G,y,ue)}let ee=!1;G.version===wt.__version?(wt.needsLights&&wt.lightsStateVersion!==Fe.state.version||wt.outputColorSpace!==yt||H.isBatchedMesh&&wt.batching===!1||!H.isBatchedMesh&&wt.batching===!0||H.isBatchedMesh&&wt.batchingColor===!0&&H._colorsTexture===null||H.isBatchedMesh&&wt.batchingColor===!1&&H._colorsTexture!==null||H.isInstancedMesh&&wt.instancing===!1||!H.isInstancedMesh&&wt.instancing===!0||H.isSkinnedMesh&&wt.skinning===!1||!H.isSkinnedMesh&&wt.skinning===!0||H.isInstancedMesh&&wt.instancingColor===!0&&H.instanceColor===null||H.isInstancedMesh&&wt.instancingColor===!1&&H.instanceColor!==null||H.isInstancedMesh&&wt.instancingMorph===!0&&H.morphTexture===null||H.isInstancedMesh&&wt.instancingMorph===!1&&H.morphTexture!==null||wt.envMap!==Nt||G.fog===!0&&wt.fog!==Mt||wt.numClippingPlanes!==void 0&&(wt.numClippingPlanes!==Dt.numPlanes||wt.numIntersection!==Dt.numIntersection)||wt.vertexAlphas!==Jt||wt.vertexTangents!==Qt||wt.morphTargets!==It||wt.morphNormals!==se||wt.morphColors!==ve||wt.toneMapping!==de||wt.morphTargetsCount!==Ie||!!wt.lightProbeGrid!=b.state.lightProbeGridArray.length>0)&&(ee=!0):(ee=!0,wt.__version=G.version);let $e=wt.currentProgram;ee===!0&&($e=nr(G,N,H),O&&G.isNodeMaterial&&O.onUpdateProgram(G,$e,wt));let dn=!1,Un=!1,gi=!1,oe=$e.getUniforms(),_e=wt.uniforms;if(_.useProgram($e.program)&&(dn=!0,Un=!0,gi=!0),G.id!==X&&(X=G.id,Un=!0),wt.needsLights){let ue=lu(b.state.lightProbeGridArray,H);wt.lightProbeGrid!==ue&&(wt.lightProbeGrid=ue,Un=!0)}if(dn||V!==y){_.buffers.depth.getReversed()&&y.reversedDepth!==!0&&(y._reversedDepth=!0,y.updateProjectionMatrix()),oe.setValue(R,"projectionMatrix",y.projectionMatrix),oe.setValue(R,"viewMatrix",y.matrixWorldInverse);let On=oe.map.cameraPosition;On!==void 0&&On.setValue(R,ht.setFromMatrixPosition(y.matrixWorld)),T.logarithmicDepthBuffer&&oe.setValue(R,"logDepthBufFC",2/(Math.log(y.far+1)/Math.LN2)),(G.isMeshPhongMaterial||G.isMeshToonMaterial||G.isMeshLambertMaterial||G.isMeshBasicMaterial||G.isMeshStandardMaterial||G.isShaderMaterial)&&oe.setValue(R,"isOrthographic",y.isOrthographicCamera===!0),V!==y&&(V=y,Un=!0,gi=!0)}if(wt.needsLights&&(Fe.state.sunShadowMap.length>0&&oe.setValue(R,"sunShadowMap",Fe.state.sunShadowMap,J),Fe.state.directionalShadowMap.length>0&&oe.setValue(R,"directionalShadowMap",Fe.state.directionalShadowMap,J),Fe.state.spotShadowMap.length>0&&oe.setValue(R,"spotShadowMap",Fe.state.spotShadowMap,J),Fe.state.pointShadowMap.length>0&&oe.setValue(R,"pointShadowMap",Fe.state.pointShadowMap,J)),H.isSkinnedMesh){oe.setOptional(R,H,"bindMatrix"),oe.setOptional(R,H,"bindMatrixInverse");let ue=H.skeleton;ue&&(ue.boneTexture===null&&ue.computeBoneTexture(),oe.setValue(R,"boneTexture",ue.boneTexture,J))}H.isBatchedMesh&&(oe.setOptional(R,H,"batchingTexture"),oe.setValue(R,"batchingTexture",H._matricesTexture,J),oe.setOptional(R,H,"batchingIdTexture"),oe.setValue(R,"batchingIdTexture",H._indirectTexture,J),oe.setOptional(R,H,"batchingColorTexture"),H._colorsTexture!==null&&oe.setValue(R,"batchingColorTexture",H._colorsTexture,J));let Fn=Z.morphAttributes;if((Fn.position!==void 0||Fn.normal!==void 0||Fn.color!==void 0)&&F.update(H,Z,$e),(Un||wt.receiveShadow!==H.receiveShadow)&&(wt.receiveShadow=H.receiveShadow,oe.setValue(R,"receiveShadow",H.receiveShadow)),(G.isMeshStandardMaterial||G.isMeshLambertMaterial||G.isMeshPhongMaterial)&&G.envMap===null&&N.environment!==null&&(_e.envMapIntensity.value=N.environmentIntensity),_e.dfgLUT!==void 0&&(_e.dfgLUT.value=m0()),Un){if(oe.setValue(R,"toneMappingExposure",I.toneMappingExposure),wt.needsLights&&hu(_e,gi),Mt&&G.fog===!0&&Ct.refreshFogUniforms(_e,Mt),Ct.refreshMaterialUniforms(_e,G,it,K,b.state.transmissionRenderTarget[y.id]),wt.needsLights&&wt.lightProbeGrid){let ue=wt.lightProbeGrid;_e.probesSH.value=ue.texture,_e.probesMin.value.copy(ue.boundingBox.min),_e.probesMax.value.copy(ue.boundingBox.max),_e.probesResolution.value.copy(ue.resolution)}es.upload(R,Kl(wt),_e,J)}if(G.isShaderMaterial&&G.uniformsNeedUpdate===!0&&(es.upload(R,Kl(wt),_e,J),G.uniformsNeedUpdate=!1),G.isSpriteMaterial&&oe.setValue(R,"center",H.center),oe.setValue(R,"modelViewMatrix",H.modelViewMatrix),oe.setValue(R,"normalMatrix",H.normalMatrix),oe.setValue(R,"modelMatrix",H.matrixWorld),G.uniformsGroups!==void 0){let ue=G.uniformsGroups;for(let On=0,_i=ue.length;On<_i;On++){let tc=ue[On];st.update(tc,$e),st.bind(tc,$e)}}return $e}function hu(y,N){y.ambientLightColor.needsUpdate=N,y.lightProbe.needsUpdate=N,y.sunLights.needsUpdate=N,y.sunLightShadows.needsUpdate=N,y.directionalLights.needsUpdate=N,y.directionalLightShadows.needsUpdate=N,y.pointLights.needsUpdate=N,y.pointLightShadows.needsUpdate=N,y.spotLights.needsUpdate=N,y.spotLightShadows.needsUpdate=N,y.rectAreaLights.needsUpdate=N,y.hemisphereLights.needsUpdate=N}function uu(y){return y.isMeshLambertMaterial||y.isMeshToonMaterial||y.isMeshPhongMaterial||y.isMeshStandardMaterial||y.isShadowMaterial||y.isShaderMaterial&&y.lights===!0}this.getActiveCubeFace=function(){return q},this.getActiveMipmapLevel=function(){return Y},this.getRenderTarget=function(){return tt},this.setRenderTargetTextures=function(y,N,Z){let G=k.get(y);G.__autoAllocateDepthBuffer=y.resolveDepthBuffer===!1,G.__autoAllocateDepthBuffer===!1&&(G.__useRenderToTexture=!1),k.get(y.texture).__webglTexture=N,k.get(y.depthTexture).__webglTexture=G.__autoAllocateDepthBuffer?void 0:Z,G.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(y,N){let Z=k.get(y);Z.__webglFramebuffer=N,Z.__useDefaultFramebuffer=N===void 0},this.setRenderTarget=function(y,N=0,Z=0){tt=y,q=N,Y=Z;let G=null,H=!1,Mt=!1;if(y){let yt=k.get(y);if(yt.__useDefaultFramebuffer!==void 0){_.bindFramebuffer(R.FRAMEBUFFER,yt.__webglFramebuffer),W.copy(y.viewport),lt.copy(y.scissor),_t=y.scissorTest,_.viewport(W),_.scissor(lt),_.setScissorTest(_t),X=-1;return}else if(yt.__webglFramebuffer===void 0)J.setupRenderTarget(y);else if(yt.__hasExternalTextures)J.rebindTextures(y,k.get(y.texture).__webglTexture,k.get(y.depthTexture).__webglTexture);else if(y.depthBuffer){let Jt=y.depthTexture;if(yt.__boundDepthTexture!==Jt){if(Jt!==null&&k.has(Jt)&&(y.width!==Jt.image.width||y.height!==Jt.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");J.setupDepthRenderbuffer(y)}}let Rt=y.texture;(Rt.isData3DTexture||Rt.isDataArrayTexture||Rt.isCompressedArrayTexture)&&(Mt=!0);let Nt=k.get(y).__webglFramebuffer;y.isWebGLCubeRenderTarget?(Array.isArray(Nt[N])?G=Nt[N][Z]:G=Nt[N],H=!0):y.samples>0&&J.useMultisampledRTT(y)===!1?G=k.get(y).__webglMultisampledFramebuffer:Array.isArray(Nt)?G=Nt[Z]:G=Nt,W.copy(y.viewport),lt.copy(y.scissor),_t=y.scissorTest}else W.copy(St).multiplyScalar(it).floor(),lt.copy(kt).multiplyScalar(it).floor(),_t=ne;if(Z!==0&&(G=B),_.bindFramebuffer(R.FRAMEBUFFER,G)&&_.drawBuffers(y,G),_.viewport(W),_.scissor(lt),_.setScissorTest(_t),H){let yt=k.get(y.texture);R.framebufferTexture2D(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_CUBE_MAP_POSITIVE_X+N,yt.__webglTexture,Z)}else if(Mt){let yt=N;for(let Rt=0;Rt<y.textures.length;Rt++){let Nt=k.get(y.textures[Rt]);R.framebufferTextureLayer(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0+Rt,Nt.__webglTexture,Z,yt)}}else if(y!==null&&Z!==0){let yt=k.get(y.texture);R.framebufferTexture2D(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,yt.__webglTexture,Z)}X=-1};function jl(y){let N=k.get(y);return(N.__readFormat!==y.format||N.__readType!==y.type)&&(N.__readFormat=y.format,N.__readType=y.type,N.__formatReadable=T.textureFormatReadable(y.format),N.__typeReadable=T.textureTypeReadable(y.type)),N}this.readRenderTargetPixels=function(y,N,Z,G,H,Mt,At,yt=0){if(!(y&&y.isWebGLRenderTarget)){Ht("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Rt=k.get(y).__webglFramebuffer;if(y.isWebGLCubeRenderTarget&&At!==void 0&&(Rt=Rt[At]),Rt){_.bindFramebuffer(R.FRAMEBUFFER,Rt);try{let Nt=y.textures[yt],Jt=Nt.format,Qt=Nt.type;y.textures.length>1&&R.readBuffer(R.COLOR_ATTACHMENT0+yt);let It=jl(Nt);if(It.__formatReadable===!1){Ht("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(It.__typeReadable===!1){Ht("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}N>=0&&N<=y.width-G&&Z>=0&&Z<=y.height-H&&R.readPixels(N,Z,G,H,gt.convert(Jt),gt.convert(Qt),Mt)}finally{let Nt=tt!==null?k.get(tt).__webglFramebuffer:null;_.bindFramebuffer(R.FRAMEBUFFER,Nt)}}},this.readRenderTargetPixelsAsync=async function(y,N,Z,G,H,Mt,At,yt=0){if(!(y&&y.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Rt=k.get(y).__webglFramebuffer;if(y.isWebGLCubeRenderTarget&&At!==void 0&&(Rt=Rt[At]),Rt)if(N>=0&&N<=y.width-G&&Z>=0&&Z<=y.height-H){_.bindFramebuffer(R.FRAMEBUFFER,Rt);let Nt=y.textures[yt],Jt=Nt.format,Qt=Nt.type;y.textures.length>1&&R.readBuffer(R.COLOR_ATTACHMENT0+yt);let It=jl(Nt);if(It.__formatReadable===!1)throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(It.__typeReadable===!1)throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");let se=R.createBuffer();R.bindBuffer(R.PIXEL_PACK_BUFFER,se),R.bufferData(R.PIXEL_PACK_BUFFER,Mt.byteLength,R.STREAM_READ),R.readPixels(N,Z,G,H,gt.convert(Jt),gt.convert(Qt),0),R.bindBuffer(R.PIXEL_PACK_BUFFER,null);let ve=tt!==null?k.get(tt).__webglFramebuffer:null;_.bindFramebuffer(R.FRAMEBUFFER,ve);let de=R.fenceSync(R.SYNC_GPU_COMMANDS_COMPLETE,0);return R.flush(),await ph(R,de,4),R.bindBuffer(R.PIXEL_PACK_BUFFER,se),R.getBufferSubData(R.PIXEL_PACK_BUFFER,0,Mt),R.bindBuffer(R.PIXEL_PACK_BUFFER,null),R.deleteBuffer(se),R.deleteSync(de),Mt}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(y,N=null,Z=0){let G=Math.pow(2,-Z),H=Math.floor(y.image.width*G),Mt=Math.floor(y.image.height*G),At=N!==null?N.x:0,yt=N!==null?N.y:0;J.setTexture2D(y,0),R.copyTexSubImage2D(R.TEXTURE_2D,Z,0,0,At,yt,H,Mt),_.unbindTexture()},this.copyTextureToTexture=function(y,N,Z=null,G=null,H=0,Mt=0){let At,yt,Rt,Nt,Jt,Qt,It,se,ve,de=y.isCompressedTexture?y.mipmaps[Mt]:y.image;if(Z!==null)At=Z.max.x-Z.min.x,yt=Z.max.y-Z.min.y,Rt=Z.isBox3?Z.max.z-Z.min.z:1,Nt=Z.min.x,Jt=Z.min.y,Qt=Z.isBox3?Z.min.z:0;else{let _e=Math.pow(2,-H);At=Math.floor(de.width*_e),yt=Math.floor(de.height*_e),y.isDataArrayTexture?Rt=de.depth:y.isData3DTexture?Rt=Math.floor(de.depth*_e):Rt=1,Nt=0,Jt=0,Qt=0}G!==null?(It=G.x,se=G.y,ve=G.z):(It=0,se=0,ve=0);let ce=gt.convert(N.format),Ie=gt.convert(N.type),wt;N.isData3DTexture?(J.setTexture3D(N,0),wt=R.TEXTURE_3D):N.isDataArrayTexture||N.isCompressedArrayTexture?(J.setTexture2DArray(N,0),wt=R.TEXTURE_2D_ARRAY):(J.setTexture2D(N,0),wt=R.TEXTURE_2D),_.activeTexture(R.TEXTURE0),_.pixelStorei(R.UNPACK_FLIP_Y_WEBGL,N.flipY),_.pixelStorei(R.UNPACK_PREMULTIPLY_ALPHA_WEBGL,N.premultiplyAlpha),_.pixelStorei(R.UNPACK_ALIGNMENT,N.unpackAlignment);let Fe=_.getParameter(R.UNPACK_ROW_LENGTH),ee=_.getParameter(R.UNPACK_IMAGE_HEIGHT),$e=_.getParameter(R.UNPACK_SKIP_PIXELS),dn=_.getParameter(R.UNPACK_SKIP_ROWS),Un=_.getParameter(R.UNPACK_SKIP_IMAGES);_.pixelStorei(R.UNPACK_ROW_LENGTH,de.width),_.pixelStorei(R.UNPACK_IMAGE_HEIGHT,de.height),_.pixelStorei(R.UNPACK_SKIP_PIXELS,Nt),_.pixelStorei(R.UNPACK_SKIP_ROWS,Jt),_.pixelStorei(R.UNPACK_SKIP_IMAGES,Qt);let gi=y.isDataArrayTexture||y.isData3DTexture,oe=N.isDataArrayTexture||N.isData3DTexture;if(y.isDepthTexture){let _e=k.get(y),Fn=k.get(N),ue=k.get(_e.__renderTarget),On=k.get(Fn.__renderTarget);_.bindFramebuffer(R.READ_FRAMEBUFFER,ue.__webglFramebuffer),_.bindFramebuffer(R.DRAW_FRAMEBUFFER,On.__webglFramebuffer);for(let _i=0;_i<Rt;_i++)gi&&(R.framebufferTextureLayer(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,k.get(y).__webglTexture,H,Qt+_i),R.framebufferTextureLayer(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,k.get(N).__webglTexture,Mt,ve+_i)),R.blitFramebuffer(Nt,Jt,At,yt,It,se,At,yt,R.DEPTH_BUFFER_BIT,R.NEAREST);_.bindFramebuffer(R.READ_FRAMEBUFFER,null),_.bindFramebuffer(R.DRAW_FRAMEBUFFER,null)}else if(H!==0||y.isRenderTargetTexture||k.has(y)){let _e=k.get(y),Fn=k.get(N);_.bindFramebuffer(R.READ_FRAMEBUFFER,L),_.bindFramebuffer(R.DRAW_FRAMEBUFFER,z);for(let ue=0;ue<Rt;ue++)gi?R.framebufferTextureLayer(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,_e.__webglTexture,H,Qt+ue):R.framebufferTexture2D(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,_e.__webglTexture,H),oe?R.framebufferTextureLayer(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,Fn.__webglTexture,Mt,ve+ue):R.framebufferTexture2D(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,Fn.__webglTexture,Mt),H!==0?R.blitFramebuffer(Nt,Jt,At,yt,It,se,At,yt,R.COLOR_BUFFER_BIT,R.NEAREST):oe?R.copyTexSubImage3D(wt,Mt,It,se,ve+ue,Nt,Jt,At,yt):R.copyTexSubImage2D(wt,Mt,It,se,Nt,Jt,At,yt);_.bindFramebuffer(R.READ_FRAMEBUFFER,null),_.bindFramebuffer(R.DRAW_FRAMEBUFFER,null)}else oe?y.isDataTexture||y.isData3DTexture?R.texSubImage3D(wt,Mt,It,se,ve,At,yt,Rt,ce,Ie,de.data):N.isCompressedArrayTexture?R.compressedTexSubImage3D(wt,Mt,It,se,ve,At,yt,Rt,ce,de.data):R.texSubImage3D(wt,Mt,It,se,ve,At,yt,Rt,ce,Ie,de):y.isDataTexture?R.texSubImage2D(R.TEXTURE_2D,Mt,It,se,At,yt,ce,Ie,de.data):y.isCompressedTexture?R.compressedTexSubImage2D(R.TEXTURE_2D,Mt,It,se,de.width,de.height,ce,de.data):R.texSubImage2D(R.TEXTURE_2D,Mt,It,se,At,yt,ce,Ie,de);_.pixelStorei(R.UNPACK_ROW_LENGTH,Fe),_.pixelStorei(R.UNPACK_IMAGE_HEIGHT,ee),_.pixelStorei(R.UNPACK_SKIP_PIXELS,$e),_.pixelStorei(R.UNPACK_SKIP_ROWS,dn),_.pixelStorei(R.UNPACK_SKIP_IMAGES,Un),Mt===0&&N.generateMipmaps&&R.generateMipmap(wt),_.unbindTexture()},this.initRenderTarget=function(y){k.get(y).__webglFramebuffer===void 0&&J.setupRenderTarget(y)},this.initTexture=function(y){y.isCubeTexture?J.setTextureCube(y,0):y.isData3DTexture?J.setTexture3D(y,0):y.isDataArrayTexture||y.isCompressedArrayTexture?J.setTexture2DArray(y,0):J.setTexture2D(y,0),_.unbindTexture()},this.resetState=function(){q=0,Y=0,tt=null,_.reset(),bt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return rn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;let e=this.getContext();e.drawingBufferColorSpace=te._getDrawingBufferColorSpace(t),e.unpackColorSpace=te._getUnpackColorSpace()}};function jh(i,t=!1){let e=i[0].index!==null,n=new Set(Object.keys(i[0].attributes)),s=new Set(Object.keys(i[0].morphAttributes)),r={},a={},o=i[0].morphTargetsRelative,l=new Me,c=0;for(let h=0;h<i.length;++h){let d=i[h],u=0;if(e!==(d.index!==null))return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+h+". All geometries must have compatible attributes; make sure index attribute exists among all geometries, or in none of them."),null;for(let f in d.attributes){if(!n.has(f))return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+h+'. All geometries must have compatible attributes; make sure "'+f+'" attribute exists among all geometries, or in none of them.'),null;r[f]===void 0&&(r[f]=[]),r[f].push(d.attributes[f]),u++}if(u!==n.size)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+h+". Make sure all geometries have the same number of attributes."),null;if(o!==d.morphTargetsRelative)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+h+". .morphTargetsRelative must be consistent throughout all geometries."),null;for(let f in d.morphAttributes){if(!s.has(f))return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+h+".  .morphAttributes must be consistent throughout all geometries."),null;a[f]===void 0&&(a[f]=[]),a[f].push(d.morphAttributes[f])}if(t){let f;if(e)f=d.index.count;else if(d.attributes.position!==void 0)f=d.attributes.position.count;else return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+h+". The geometry must have either an index or a position attribute"),null;l.addGroup(c,f,h),c+=f}}if(e){let h=0,d=[];for(let u=0;u<i.length;++u){let f=i[u].index;for(let g=0;g<f.count;++g)d.push(f.getX(g)+h);h+=i[u].attributes.position.count}l.setIndex(d)}for(let h in r){let d=Qh(r[h]);if(!d)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the "+h+" attribute."),null;l.setAttribute(h,d)}for(let h in a){let d=a[h][0].length;if(d!==0){l.morphAttributes=l.morphAttributes||{},l.morphAttributes[h]=[];for(let u=0;u<d;++u){let f=[];for(let M=0;M<a[h].length;++M)f.push(a[h][M][u]);let g=Qh(f);if(!g)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the "+h+" morphAttribute."),null;l.morphAttributes[h].push(g)}}}return l}function Qh(i){let t,e,n,s=-1,r=0;for(let c=0;c<i.length;++c){let h=i[c];if(t===void 0&&(t=h.array.constructor),t!==h.array.constructor)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.array must be of consistent array types across matching attributes."),null;if(e===void 0&&(e=h.itemSize),e!==h.itemSize)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.itemSize must be consistent across matching attributes."),null;if(n===void 0&&(n=h.normalized),n!==h.normalized)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.normalized must be consistent across matching attributes."),null;if(s===-1&&(s=h.gpuType),s!==h.gpuType)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.gpuType must be consistent across matching attributes."),null;r+=h.count*e}let a=new t(r),o=new we(a,e,n),l=0;for(let c=0;c<i.length;++c){let h=i[c];if(h.isInterleavedBufferAttribute){let d=l/e;for(let u=0,f=h.count;u<f;u++)for(let g=0;g<e;g++){let M=h.getComponent(u,g);o.setComponent(u+d,g,M)}}else a.set(h.array,l);l+=h.count*e}return s!==void 0&&(o.gpuType=s),o}function tu(i,t=Math.PI/3){let e=i.index?i.toNonIndexed():i,n=e.attributes.position,s=n.count,r;if(n.isBufferAttribute===!0&&n.itemSize===3&&n.normalized===!1)r=n.array;else{r=new Float64Array(s*3);for(let v=0;v<s;v++)r[3*v+0]=n.getX(v),r[3*v+1]=n.getY(v),r[3*v+2]=n.getZ(v)}let a=Math.cos(t),o=(1+1e-10)*100,l=s/3,c=new Float64Array(l*3);for(let v=0;v<l;v++){let S=9*v,b=r[S+0],C=r[S+1],x=r[S+2],w=r[S+3],I=r[S+4],P=r[S+5],O=r[S+6],B=r[S+7],L=r[S+8],z=O-w,q=B-I,Y=L-P,tt=b-w,X=C-I,V=x-P,W=q*V-Y*X,lt=Y*tt-z*V,_t=z*X-q*tt,Yt=1/(Math.sqrt(W*W+lt*lt+_t*_t)||1);c[3*v+0]=W*Yt,c[3*v+1]=lt*Yt,c[3*v+2]=_t*Yt}let h=new Int32Array(s),d=new Float64Array(s*3),u=1;for(;u<s*2;)u<<=1;let f=u-1,g=new Int32Array(u),M=0;for(let v=0;v<s;v++){let S=3*v,b=Math.trunc(r[S+0]*o),C=Math.trunc(r[S+1]*o),x=Math.trunc(r[S+2]*o),w=(Math.imul(b,73856093)^Math.imul(C,19349663)^Math.imul(x,83492791))&f;for(;;){let I=g[w];if(I===0){let O=3*M;d[O+0]=b,d[O+1]=C,d[O+2]=x,g[w]=M+1,h[v]=M++;break}let P=3*(I-1);if(d[P+0]===b&&d[P+1]===C&&d[P+2]===x){h[v]=I-1;break}w=w+1&f}}let m=new Int32Array(M+1);for(let v=0;v<s;v++)m[h[v]+1]++;for(let v=0;v<M;v++)m[v+1]+=m[v];let p=new Int32Array(s),A=m.slice(0,M);for(let v=0;v<l;v++){let S=3*v;p[A[h[S+0]]++]=v,p[A[h[S+1]]++]=v,p[A[h[S+2]]++]=v}let E=new Float32Array(s*3);for(let v=0;v<l;v++){let S=3*v,b=c[S+0],C=c[S+1],x=c[S+2];for(let w=0;w<3;w++){let I=S+w,P=h[I],O=0,B=0,L=0;for(let q=m[P],Y=m[P+1];q<Y;q++){let tt=3*p[q],X=c[tt+0],V=c[tt+1],W=c[tt+2];b*X+C*V+x*W>a&&(O+=X,B+=V,L+=W)}let z=1/(Math.sqrt(O*O+B*B+L*L)||1);E[3*I+0]=O*z,E[3*I+1]=B*z,E[3*I+2]=L*z}}return e.setAttribute("normal",new we(E,3,!1)),e}function iu(i){let t=new ci;t.background=new qt(1713718);let e=(a,o,l,c,h)=>{let d=new le(new Ln(a,o),new xn({color:new qt(c).multiplyScalar(h),side:Je}));d.position.set(...l),d.lookAt(0,0,0),t.add(d)};e(12,6,[0,7,1],16777215,3.2),e(3,8,[-7,2,2],15922943,2.6),e(3,8,[7,1.8,-1],11128053,2.4),e(14,2.4,[0,1.6,-8],16777215,2),e(14,1.6,[0,.8,8],14411506,1.4);let n=new le(new Ln(60,60),new xn({color:4609642}));n.rotation.x=-Math.PI/2,n.position.y=-3,t.add(n);let s=new ns(i),r=s.fromScene(t,.015).texture;return s.dispose(),r}function su(){let i=document.createElement("canvas");i.width=8,i.height=1024;let t=i.getContext("2d");for(let n=0;n<i.height;n++){let s=128+(Math.random()-.5)*70+Math.sin(n*1.7)*28;t.fillStyle=`rgb(${s|0},${s|0},${s|0})`,t.fillRect(0,n,i.width,1)}let e=new Vi(i);return e.wrapS=e.wrapT=Di,e}function js(i,t=128){let e=[];for(let n=0;n<i.length-1;n++){let[s,r]=i[n],[a,o]=i[n+1];if(s===a&&r===o)continue;let l=new Us([new ct(s,r),new ct(a,o)],t),c=Math.hypot(a-s,o-r),h=l.attributes.uv;for(let d=0;d<h.count;d++)h.setY(d,h.getY(d)*c/40+r/40);e.push(l)}return jh(e)}function co(i,t,e,n,s){let r=[];for(let a=e;a<n-1e-6;a+=s)r.push([t,a],[i,a+s*.45],[i,a+s*.55]);return r.push([t,n]),r}function rs(i,t,e=.8){let n=new Hi(i,{depth:t,bevelEnabled:e>0,bevelThickness:e,bevelSize:e,bevelSegments:1,curveSegments:96});return tu(n,Math.PI/7)}function tr(i,t,e,n=new Pn){let s=-i/2,r=-t/2;return n.moveTo(s+e,r),n.lineTo(s+i-e,r),n.quadraticCurveTo(s+i,r,s+i,r+e),n.lineTo(s+i,r+t-e),n.quadraticCurveTo(s+i,r+t,s+i-e,r+t),n.lineTo(s+e,r+t),n.quadraticCurveTo(s,r+t,s,r+t-e),n.lineTo(s,r+e),n.quadraticCurveTo(s,r,s+e,r),n}var ss=(i,t,e)=>{let n=new qn;return n.absarc(i,t,e,0,Math.PI*2,!0),n};function g0(){let i=su(),t={steel:new Ne({color:14673130,metalness:1,roughness:.2,bumpMap:i,bumpScale:.35,envMapIntensity:1.25}),steelDark:new Ne({color:10134445,metalness:1,roughness:.3}),alu:new Ne({color:15659508,metalness:1,roughness:.3,envMapIntensity:1.15}),brass:new Ne({color:15121254,metalness:1,roughness:.22,bumpMap:i,bumpScale:.35,envMapIntensity:1.2})},e=(o,l)=>new le(o,l);return{shaft:()=>{let o=new xe;o.add(e(js([[0,0],[9.2,0],[10,.8],[10,24],[13.2,24],[14,24.8],[14,56],[12.4,56],[12.4,59.5],[14,59.5],[14,78],[19.2,78],[20,78.8],[20,90],[19.2,90.8],[12.6,90.8],[12,91.4],[12,97],...co(12,11.1,97,128,1.5),[10.4,128.8],[0,128.8]]),t.steel));let l=e(rs(tr(22,6,3),1.2,.3),t.steelDark);return l.rotation.set(0,0,Math.PI/2),l.position.set(0,40,13.2),o.add(l),o.rotation.z=Math.PI/2,o},flange:()=>{let o=new Pn;o.absarc(0,0,60,0,Math.PI*2,!1),o.holes.push(ss(0,0,15.5));for(let d=0;d<6;d++){let u=d*Math.PI/3+Math.PI/6;o.holes.push(ss(Math.cos(u)*45,Math.sin(u)*45,5.6))}let l=e(rs(o,12,1),t.steel);l.rotation.x=-Math.PI/2,l.position.y=1;let c=e(js([[15.5,12],[30,12],[30,30],[29.2,30.8],[16.3,30.8],[15.5,30],[15.5,12]]),t.steel),h=new xe;return h.add(l,c),h.rotation.x=.75,h},housing:()=>{let o=[[-48,-28],[48,-28],[-48,28],[48,28]],l=tr(120,80,7);o.forEach(([f,g])=>l.holes.push(ss(f,g,3.6))),l.holes.push(ss(0,0,9));let c=tr(120,80,7);o.forEach(([f,g])=>c.holes.push(ss(f,g,5.8))),c.holes.push(tr(76,48,8,new qn));let h=e(rs(l,10,.6),t.alu);h.rotation.x=-Math.PI/2,h.position.y=.6;let d=e(rs(c,20,.8),t.alu);d.rotation.x=-Math.PI/2,d.position.y=11;let u=new xe;return u.add(h,d),u.rotation.x=.65,u},adapter:()=>{let o=new Pn;for(let u=0;u<6;u++){let f=u*Math.PI/3,g=Math.cos(f)*18.5,M=Math.sin(f)*18.5;u?o.lineTo(g,M):o.moveTo(g,M)}o.closePath(),o.holes.push(ss(0,0,6));let l=e(rs(o,14,1.2),t.brass);l.rotation.x=-Math.PI/2,l.position.y=17.2;let c=e(js([[6,32],[10.6,32],[11,32.6],...co(11,10.1,33,46,1.5),[9.6,46.8],[6,46.8]]),t.brass),h=e(js([[6,0],[8.2,0],[9,.8],...co(9,8.2,1,12,1.25),[9,12],[12,12],[12,16],[6,16]]),t.brass),d=new xe;return d.add(l,c,h),d.rotation.x=.35,d}}}function eu(i,t=118){let e=new xe;e.add(i);let n=new _n().setFromObject(i),s=n.getCenter(new D);i.position.sub(s);let r=n.getSize(new D).length()/2;return e.scale.setScalar(t/r),e}function _0(){let i=document.createElement("canvas");i.width=i.height=128;let t=i.getContext("2d"),e=t.createRadialGradient(64,64,0,64,64,64);e.addColorStop(0,"rgba(0,0,0,0.55)"),e.addColorStop(1,"rgba(0,0,0,0)"),t.fillStyle=e,t.fillRect(0,0,128,128);let n=new le(new Ln(1,1),new xn({map:new Vi(i),transparent:!0,depthWrite:!1}));return n.rotation.x=-Math.PI/2,n.scale.set(260,120,1),n.position.y=-122,n}var x0=i=>1-Math.pow(1-i,3);function Uv(i,{reducedMotion:t=!1}={}){let e=i.querySelector("canvas"),n=new Qs({canvas:e,antialias:!0,alpha:!0,powerPreference:"high-performance"});n.setPixelRatio(Math.min(window.devicePixelRatio||1,1.75)),n.toneMapping=Ji,n.toneMappingExposure=1.1,n.outputColorSpace=De;let s=new ci;s.environment=iu(n);let r=new Ee(30,1,1,3e3);r.position.set(0,40,430),r.lookAt(0,0,0);let a=new $n(16777215,2.6);a.position.set(160,260,220),s.add(a);let o=new $n(10274047,1.8);o.position.set(-260,120,-220),s.add(o),s.add(new Wi(14674165,726564,.35)),s.add(_0());let l=g0(),c={},h=new xe;s.add(h);let d=new xe;d.rotation.x=.18,h.add(d);let u=i.querySelector("[data-dro]"),f=0,g=0,M=i.closest(".hero")||i;!t&&window.matchMedia("(pointer: fine)").matches&&(M.addEventListener("pointermove",V=>{let W=M.getBoundingClientRect();f=((V.clientX-W.left)/W.width-.5)*.7,g=((V.clientY-W.top)/W.height-.5)*.35}),M.addEventListener("pointerleave",()=>{f=0,g=0}));let m=null,p=null,A=[...i.querySelectorAll("[data-part]")],E=i.querySelector("[data-viewer-info]"),v=t?0:.006,S=0,b=.18,C=!1,x=0,w=0,I=0,P=0,O=0,B=null;function L(V,W=!0){if(V===p)return;B&&(d.remove(B.from),B.from.scale.setScalar(B.from.userData.s),B.to.scale.setScalar(B.to.userData.s),B=null);let lt=c[V]||(c[V]=eu(l[V]()));A.forEach(Yt=>Yt.setAttribute("aria-pressed",String(Yt.dataset.part===V)));let _t=A.find(Yt=>Yt.dataset.part===V);E&&_t&&(E.innerHTML=`<strong>${_t.dataset.title}</strong><span>${_t.dataset.desc}</span>`),!m||!W||t?(m&&d.remove(m),d.add(lt),lt.scale.setScalar(lt.userData.s||lt.scale.x),m=lt):(B={from:m,to:lt,t:0},lt.userData.s=lt.userData.s||lt.scale.x,lt.scale.setScalar(.001),d.add(lt),v+=.25),m=lt,p=V}c.shaft=eu(l.shaft()),L("shaft",!1),A.forEach(V=>V.addEventListener("click",()=>L(V.dataset.part))),e.addEventListener("pointerdown",V=>{C=!0,x=I=V.clientX,w=P=V.clientY,O=performance.now(),e.setPointerCapture(V.pointerId)}),e.addEventListener("pointermove",V=>{if(!C)return;let W=V.clientX-x,lt=V.clientY-w;x=V.clientX,w=V.clientY,v=W*.006,S=lt*.004,d.rotation.y+=W*.01,b=Math.max(-.6,Math.min(.9,b+lt*.006)),O=performance.now()});let z=V=>{C&&(C=!1,Math.hypot(V.clientX-I,V.clientY-P)<6&&(v+=.35))};e.addEventListener("pointerup",z),e.addEventListener("pointercancel",z);let q=()=>{let V=e.clientWidth,W=e.clientHeight;!V||!W||(n.setSize(V,W,!1),r.aspect=V/W,r.position.z=V/W<1?520:430,r.updateProjectionMatrix())};new ResizeObserver(q).observe(e),q();let Y=!0;new IntersectionObserver(([V])=>{Y=V.isIntersecting}).observe(i);let tt=performance.now();function X(V){let W=Math.min(50,V-tt)/16.67;if(tt=V,Y&&!document.hidden){if(C||(d.rotation.y+=v*W,v+=((t?0:.006)-v)*.03*W,S*=.9),d.rotation.x+=(b-d.rotation.x)*.08*W,h.rotation.y+=(f-h.rotation.y)*.05*W,h.rotation.x+=(g-h.rotation.x)*.05*W,u){let lt=(d.rotation.y*180/Math.PI%360+360)%360;u.textContent="C "+lt.toFixed(1).padStart(5,"0")+"\xB0  \xB7  B "+(d.rotation.x*180/Math.PI).toFixed(1)+"\xB0"}if(t||(d.position.y=Math.sin(V/900)*4),B){B.t=Math.min(1,B.t+.045*W);let lt=x0(B.t);B.from.scale.setScalar(B.from.userData.s*Math.max(.001,1-lt*1.6)),B.to.scale.setScalar(B.to.userData.s*Math.max(.001,Math.min(1,(lt-.25)/.75))),B.t>=1&&(d.remove(B.from),B.from.scale.setScalar(B.from.userData.s),B=null)}n.render(s,r)}requestAnimationFrame(X)}c.shaft.userData.s=c.shaft.scale.x,requestAnimationFrame(X),i.classList.add("is-3d")}var v0=i=>Math.max(0,Math.min(1,i)),He=(i,t,e)=>v0((i-t)/(e-t)),Nn=(i,t,e)=>i+(t-i)*e,hn=i=>i*i*(3-2*i),ho=[[0,0],[9.2,0],[10,.8],[10,24],[13.2,24],[14,24.8],[14,56],[12.4,56],[12.4,59.5],[14,59.5],[14,78],[19.2,78],[20,78.8],[20,90],[19.2,90.8],[12.6,90.8],[12,91.4],[12,97],...co(12,11.1,97,128,1.5),[10.4,128.8],[0,128.8]],nu=64.4;function y0(i){let t=0;for(let e=0;e<ho.length-1;e++){let[n,s]=ho[e],[r,a]=ho[e+1];if(s===a){Math.abs(i-s)<.01&&(t=Math.max(t,n,r));continue}let o=Math.min(s,a),l=Math.max(s,a);i>=o&&i<=l&&(t=Math.max(t,Nn(n,r,(i-s)/(a-s))))}return t}function Fv(i,{reducedMotion:t=!1}={}){let e=i.querySelector(".story-canvas"),n=new Qs({canvas:e,antialias:!0,alpha:!0,powerPreference:"high-performance"});n.setPixelRatio(Math.min(window.devicePixelRatio||1,1.75)),n.toneMapping=Ji,n.toneMappingExposure=1.1,n.outputColorSpace=De,n.localClippingEnabled=!0;let s=new ci;s.environment=iu(n);let r=new Ee(28,1,1,3e3),a=new $n(16777215,2.6);a.position.set(160,260,220),s.add(a);let o=new $n(10274047,1.8);o.position.set(-260,120,-220),s.add(o),s.add(new Wi(14674165,726564,.35));let l=new Oe(new D(1,0,0),0),c=new Oe(new D(-1,0,0),0),h=new Oe(new D(-1,0,0),0),d=su(),u=new Ne({color:14673130,metalness:1,roughness:.2,bumpMap:d,bumpScale:.35,envMapIntensity:1.25,clippingPlanes:[l],side:Je}),f=new Ne({color:9279135,metalness:.9,roughness:.55,clippingPlanes:[c]}),g=new Ne({color:10134445,metalness:.9,roughness:.35,bumpMap:d,bumpScale:.2}),M=new Ne({color:2764598,metalness:.8,roughness:.5,clippingPlanes:[h]}),m=new Ne({color:3817544,metalness:.85,roughness:.35}),p=new Ne({color:6252659,metalness:.9,roughness:.3}),A=new Ne({color:16757053,metalness:.7,roughness:.25,emissive:2756608}),E=new xe;s.add(E);let v=new xe;v.rotation.z=-Math.PI/2,v.position.x=-nu,E.add(v);let S=new xe;v.add(S),S.add(new le(js(ho,160),u));let b=new le(rs(tr(22,6,3),1.2,.3),M);b.rotation.set(0,0,Math.PI/2),b.position.set(0,40,12.9),S.add(b);let C=new le(new Xn(21.5,21.5,143,96,1,!1),f);C.position.y=59.5,S.add(C);let x=new le(new Es(21.5,96),g);x.rotation.y=Math.PI/2,s.add(x);let w=new xe,I=new le(new Xn(36,36,26,96),p);I.position.y=-25,w.add(I);for(let Tt=0;Tt<3;Tt++){let R=new le(new In(11,18,10),m),Et=Tt*Math.PI*2/3;R.position.set(Math.sin(Et)*26.5,-6,Math.cos(Et)*26.5),R.rotation.y=Et,w.add(R)}S.add(w);let P=new xe,O=new Pn;O.moveTo(0,0),O.lineTo(-6,-9),O.lineTo(6,-9),O.closePath();let B=new le(new Hi(O,{depth:5,bevelEnabled:!1}),A);B.position.z=-2.5,P.add(B);let L=new le(new In(12,60,14),m);L.position.y=-39,P.add(L),s.add(P);let z=new xe,q=new le(new Xn(3,3,26,32),new Ne({color:13620957,metalness:1,roughness:.25,bumpMap:d,bumpScale:.5}));q.position.y=13,z.add(q);let Y=new le(new Xn(8,6,26,48),m);Y.position.y=39,z.add(Y),s.add(z);let tt=new le(new Fs(27,.9,16,128),new xn({color:9091558,transparent:!0,opacity:.9,blending:Zi,depthWrite:!1}));tt.rotation.y=Math.PI/2,s.add(tt);let X=360,V=new Float32Array(X*6),W=new Float32Array(X*6),lt=Array.from({length:X},()=>({life:0})),_t=new Me;_t.setAttribute("position",new we(V,3)),_t.setAttribute("color",new we(W,3));let Yt=new Ts(_t,new zi({vertexColors:!0,transparent:!0,blending:Zi,depthWrite:!1}));Yt.frustumCulled=!1,s.add(Yt);let Zt=0,jt=(Tt,R,Et,Pt,T=!1)=>{for(let _=0;_<Pt;_++){let U=lt[Zt];Zt=(Zt+1)%X;let k=Math.random()*Math.PI*2,J=.6+Math.random()*2.2;U.x=Tt,U.y=R,U.z=Et,U.vx=Math.cos(k)*J*.8,U.vz=Math.abs(Math.sin(k))*J+.4,U.vy=T?Math.random()*2.2+.4:-Math.random()*1.6+.6,U.life=1,U.decay=.018+Math.random()*.03}},K=Tt=>{for(let R=0;R<X;R++){let Et=lt[R],Pt=R*6;if(Et.life>0){Et.vy-=.09*Tt,Et.x+=Et.vx*Tt,Et.y+=Et.vy*Tt,Et.z+=Et.vz*Tt,Et.life-=Et.decay*Tt,Et.y<-75&&(Et.life=0);let T=Math.max(0,Et.life);V[Pt]=Et.x,V[Pt+1]=Et.y,V[Pt+2]=Et.z,V[Pt+3]=Et.x-Et.vx*2.2,V[Pt+4]=Et.y-Et.vy*2.2,V[Pt+5]=Et.z-Et.vz*2.2,W[Pt]=1*T,W[Pt+1]=(.55+.35*T)*T,W[Pt+2]=.15*T*T,W[Pt+3]=.6*T,W[Pt+4]=.25*T,W[Pt+5]=0}else W.fill(0,Pt,Pt+6)}_t.attributes.position.needsUpdate=!0,_t.attributes.color.needsUpdate=!0},it=[...i.querySelectorAll("[data-anchor]")].map(Tt=>{let[R,Et,Pt]=Tt.dataset.anchor.split(",").map(Number);return{el:Tt,v:new D(R,Et,Pt)}}),xt=i.querySelector(".story-stage"),zt=new D,St=300,kt=()=>{let Tt=e.clientWidth,R=e.clientHeight;!Tt||!R||(n.setSize(Tt,R,!1),r.aspect=Tt/R,St=300*Math.max(1,1.45/r.aspect),r.updateProjectionMatrix())};new ResizeObserver(kt).observe(e),kt();let ne=!1;new IntersectionObserver(([Tt])=>{ne=Tt.isIntersecting},{rootMargin:"100px"}).observe(i);let et=-Math.PI/2,Q=0,rt=0,at=99,ht=-99,Bt=performance.now(),Ut=new D(0,-Math.sin(et),Math.cos(et));z.quaternion.copy(new Qe().setFromUnitVectors(new D(0,1,0),Ut));function Gt(Tt){requestAnimationFrame(Gt);let R=Math.min(50,Tt-Bt)/16.67;if(Bt=Tt,!ne||document.hidden)return;let Et=parseFloat(i.dataset.progress||"0");Q+=(Et-Q)*Math.min(1,.14*R);let Pt=hn(He(Q,.5,.56))-hn(He(Q,.72,.78));r.position.set(0,Nn(62,175,Pt),St*Nn(1,.78,Pt)),r.lookAt(0,Nn(-6,0,Pt),0);let T=He(Q,.06,.1),_=hn(He(Q,.1,.5)),U=Nn(70,-66,_);l.constant=-U,c.constant=U;let k=Q>.1&&Q<.5,J=y0(U+nu),ot=1-T+He(Q,.5,.54);P.position.set(Math.min(U,66),-Math.max(J,12)-.3-ot*30,0),P.visible=Q<.56,x.position.x=U,x.visible=U>-64.5&&U<66.5,k&&Math.abs(U-at)>.02&&jt(U,-J,.5,Math.min(14,2+Math.abs(U-at)*6)),at=U;let ut=hn(He(Q,.5,.56));if(w.position.y=-ut*60,w.visible=ut<.99,C.visible=Q<.56,Q<.5)rt+=.32*R*(k?1:.15);else{let dt=hn(He(Q,.5,.55)),j=Nn(et,-.35,hn(He(Q,.74,.84))),gt=Math.round((rt-j)/(Math.PI*2))*Math.PI*2+j;rt=Nn(rt,gt,Math.min(1,.1*R+dt*.4))}S.rotation.y=rt;let $=hn(He(Q,.54,.58)),nt=hn(He(Q,.58,.68)),pt=hn(He(Q,.68,.72)),Ct=Nn(-35.4+3,-13.4-3,nt);h.constant=Q<.58?-99:Ct+3;let ft=new D(Ct,0,0).addScaledVector(Ut,14.1),mt=(1-$)*45+pt*50;z.position.copy(ft).addScaledVector(Ut,mt),z.visible=Q>.52&&Q<.74,q.rotation.y+=.6*R,Q>.58&&Q<.68&&Math.abs(Ct-ht)>.02&&jt(ft.x,ft.y,ft.z,Math.min(10,2+Math.abs(Ct-ht)*8),!0),ht=Ct;let Dt=hn(He(Q,.72,.86));tt.position.x=Nn(-72,72,Dt),tt.visible=Q>.71&&Q<.9,tt.material.opacity=.9*(1-He(Q,.86,.9));let Ft=hn(He(Q,.86,1));E.rotation.y=Ft*.55+(t?0:Math.sin(Tt/1400)*.04*Ft),E.rotation.x=Ft*.2,E.position.y=Ft*8,K(R),n.render(s,r);let Xt=e.clientWidth,F=e.clientHeight;it.forEach(dt=>{zt.copy(dt.v).applyMatrix4(E.matrixWorld).project(r),dt.el.style.transform=`translate(${((zt.x+1)/2*Xt).toFixed(1)}px, ${((1-zt.y)/2*F).toFixed(1)}px)`,dt.el.classList.toggle("is-on",Q>.72&&(tt.position.x>dt.v.x||Q>.86))}),xt&&xt.style.setProperty("--tool",((U+70)/136).toFixed(3))}requestAnimationFrame(Gt),i.classList.add("is-3d")}export{Fv as initStory,Uv as initViewer};
